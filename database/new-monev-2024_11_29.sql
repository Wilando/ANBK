...
MySQL - 8.0.30 : Database - monev_db
*********************************************************************
*/
...
(1,'login','login',NULL,'logged',NULL,'App\\Models\\User',1,'[]',NULL,'2024-10-08 10:41:35','2024-10-08 10:41:35'),
(2,'logout','logout aplikasi','App\\Models\\User','logout',1,'App\\Models\\User',1,'[]',NULL,'2024-10-08 10:41:47','2024-10-08 10:41:47'),
(3,'login','login',NULL,'logged',NULL,'App\\Models\\User',1,'[]',NULL,'2024-10-08 10:48:13','2024-10-08 10:48:13'),
(4,'settings','memperbarui  data konfigurasi aplikasi','App\\Models\\Setting','updated',1,'App\\Models\\User',1,'[]',NULL,'2024-10-08 10:51:35','2024-10-08 10:51:35'),
(5,'user','memperbarui  profil akun','App\\Models\\User','updated',1,'App\\Models\\User',1,'{\"old\":{\"id\":1,\"username\":\"superadmin\",\"name\":\"Avril Lavigne\",\"email\":\"avril@gmail.com\",\"email_verified_at\":null,\"avatar\":\"users\\/usRilDDhGEAooa1SaASDLpWuOiecOWZCnW1EKrY8.png\",\"is_active\":1,\"unker_id\":0,\"created_at\":\"2022-08-10T21:40:00.000000Z\",\"updated_at\":\"2024-10-08T03:41:47.000000Z\",\"deleted_at\":null},\"new\":{\"id\":1,\"username\":\"superadmin\",\"name\":\"Avril Lavigne\",\"email\":\"avril@gmail.com\",\"email_verified_at\":null,\"avatar\":\"users\\/355E1lzftbUPLgzn6yjEJMPyVYpYwejxoSCKDdfT.jpg\",\"is_active\":1,\"unker_id\":0,\"created_at\":\"2022-08-11 04:40:00\",\"updated_at\":\"2024-10-08 10:51:48\",\"deleted_at\":null}}',NULL,'2024-10-08 10:51:48','2024-10-08 10:51:48'),
(6,'logout','logout aplikasi','App\\Models\\User','logout',1,'App\\Models\\User',1,'[]',NULL,'2024-10-08 10:51:57','2024-10-08 10:51:57'),
(7,'login','login',NULL,'logged',NULL,'App\\Models\\User',1,'[]',NULL,'2024-10-08 11:00:44','2024-10-08 11:00:44'),
(8,'logout','logout aplikasi','App\\Models\\User','logout',1,'App\\Models\\User',1,'[]',NULL,'2024-10-08 11:07:42','2024-10-08 11:07:42'),
(9,'login','login',NULL,'logged',NULL,'App\\Models\\User',1,'[]',NULL,'2024-10-08 11:07:54','2024-10-08 11:07:54'),
(10,'settings','memperbarui  data konfigurasi aplikasi','App\\Models\\Setting','updated',1,'App\\Models\\User',1,'[]',NULL,'2024-10-08 13:03:38','2024-10-08 13:03:38'),
(11,'settings','memperbarui  data konfigurasi aplikasi','App\\Models\\Setting','updated',1,'App\\Models\\User',1,'[]',NULL,'2024-10-08 13:03:42','2024-10-08 13:03:42'),
(12,'logout','logout aplikasi','App\\Models\\User','logout',1,'App\\Models\\User',1,'[]',NULL,'2024-10-08 13:03:52','2024-10-08 13:03:52'),
(13,'login','login',NULL,'logged',NULL,'App\\Models\\User',1,'[]',NULL,'2024-10-08 13:04:03','2024-10-08 13:04:03');
...
CREATE TABLE `chat_sessions` (
  ...
  CONSTRAINT `chat_sessions_ibfk_1` FOREIGN KEY (`id_ticket`) REFERENCES `tickets` (`id_ticket`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `feedback` (
  ...
  UNIQUE KEY `id_user` (`id_user`,`period_start`,`period_end`),
  CONSTRAINT `feedback_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `master_kegiatan` (
  ...
  KEY `fk_kegiatan_unker` (`id_unker`),
  CONSTRAINT `fk_kegiatan_unker` FOREIGN KEY (`id_unker`) REFERENCES `master_unker` (`ID`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `master_kegiatan_ibfk_1` FOREIGN KEY (`id_program`) REFERENCES `master_program` (`id_program`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=524 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

/*Data for the table `master_kegiatan` */
...
(1,1,'1.01.01.1.01','Perencanaan  Penganggaran  dan Evaluasi Kinerja Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(2,1,'1.01.01.1.02','Administrasi Keuangan Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(3,1,'1.01.01.1.03','Administrasi Barang Milik Daerah padaPerangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(4,1,'1.01.01.1.05','Administrasi Kepegawaian Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(5,1,'1.01.01.1.06','Administrasi Umum Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(6,1,'1.01.01.1.07','Pengadaan Barang Milik Daerah PenunjangUrusan Pemerintah Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(7,1,'1.01.01.1.08','Penyediaan Jasa Penunjang UrusanPemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(8,1,'1.01.01.1.09','Pemeliharaan Barang Milik Daerah Penunjang Urusan Pemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(9,2,'1.01.02.1.01','Pengelolaan Pendidikan Sekolah Menengah Atas',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(10,2,'1.01.02.1.02','Pengelolaan Pendidikan Sekolah Menengah Kejuruan',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(11,2,'1.01.02.1.03','Pengelolaan Pendidikan Khusus',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(12,3,'1.01.04.1.01','Pemindahan Pendidik dan Tenaga Kependidikan Lintas Kabupaten/Kota dalam 1 (Satu) Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(13,4,'1.02.01.1.01','Perencanaan  Penganggaran  dan Evaluasi Kinerja Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(14,4,'1.02.01.1.02','Administrasi Keuangan Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(15,4,'1.02.01.1.03','Administrasi Barang Milik Daerah padaPerangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(16,4,'1.02.01.1.05','Administrasi Kepegawaian Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(17,4,'1.02.01.1.06','Administrasi Umum Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(18,4,'1.02.01.1.07','Pengadaan Barang Milik Daerah PenunjangUrusan Pemerintah Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(19,4,'1.02.01.1.08','Penyediaan Jasa Penunjang UrusanPemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(20,4,'1.02.01.1.09','Pemeliharaan Barang Milik Daerah Penunjang Urusan Pemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(21,4,'1.02.01.1.10','Peningkatan Pelayanan BLUD',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(22,5,'1.02.02.1.01','Penyediaan Fasilitas Pelayanan  Sarana  Prasarana dan Alat Kesehatan untuk UKP Rujukan  UKM dan UKM Rujukan Tingkat Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(23,5,'1.02.02.1.02','Penyediaan Layanan Kesehatan untuk UKP Rujukan  UKM dan UKM Rujukan Tingkat Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(24,5,'1.02.02.1.03','Penyelenggaraan Sistem Informasi Kesehatan Secara Terintegrasi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(25,5,'1.02.02.1.04','Penerbitan Izin Rumah Sakit Kelas B dan Fasilitas Pelayanan Kesehatan Tingkat Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(26,6,'1.02.03.1.01','Perencanaan Kebutuhan Sumber Daya Manusia Kesehatan untuk UKM dan UKP Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(27,6,'1.02.03.1.02','Pengembangan Mutu dan Peningkatan Kompetensi Teknis Sumber Daya Manusia Kesehatan Tingkat Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(28,7,'1.02.04.1.01','Penerbitan Pengakuan Pedagang Besar Farmasi (PBF) Cabang dan Cabang Penyalur Alat Kesehatan (PAK)',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(29,7,'1.02.04.1.02','Penerbitan Izin Usaha Kecil Obat Tradisional (UKOT)',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(30,8,'1.02.05.1.01','Advokasi  Pemberdayaan  Kemitraan  Peningkatan Peran Serta Masyarakat dan Lintas Sektor Tingkat Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(31,8,'1.02.05.1.03','Pengembangan dan Pelaksanaan Upaya Kesehatan Bersumber Daya Masyarakat (UKBM) Tingkat Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(32,9,'1.03.01.1.02','Administrasi Keuangan Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(33,9,'1.03.01.1.03','Administrasi Barang Milik Daerah padaPerangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(34,9,'1.03.01.1.05','Administrasi Kepegawaian Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(35,9,'1.03.01.1.06','Administrasi Umum Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(36,9,'1.03.01.1.07','Pengadaan Barang Milik Daerah PenunjangUrusan Pemerintah Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(37,9,'1.03.01.1.08','Penyediaan Jasa Penunjang UrusanPemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(38,9,'1.03.01.1.09','Pemeliharaan Barang Milik Daerah Penunjang Urusan Pemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(39,10,'1.03.02.1.02','Pengembangan dan Pengelolaan Sistem Irigasi Primer dan Sekunder pada Daerah Irigasi yang Luasnya 1000 Ha-3000 Ha dan Daerah Irigasi Lintas Daerah Kabupaten/Kota',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(40,11,'1.03.03.1.01','Pengelolaan dan Pengembangan Sistem Penyediaan Air Minum (SPAM) Lintas Kabupaten/Kota',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(41,12,'1.03.04.1.01','Pengembangan Sistem dan Pengelolaan Persampahan Regional',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(42,13,'1.03.05.1.01','Pengelolaan dan Pengembangan Sistem Air Limbah Domestik Regional',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(43,14,'1.03.07.1.01','Penyelenggaraan Infrastruktur pada Permukiman di Kawasan Strategis Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(44,15,'1.03.08.1.01','Penetapan dan Penyelenggaraan Bangunan Gedung untuk Kepentingan Strategis Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(45,16,'1.03.09.1.01','Penyelenggaraan Penataan Bangunan dan Lingkungan di Kawasan Strategis Daerah Provinsi dan Lintas Daerah Kabupaten/Kota',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(46,17,'1.03.10.1.01','Penyelenggaraan Jalan Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(47,18,'1.03.11.1.01','Penyelenggaraan Pelatihan Tenaga Ahli Konstruksi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(48,18,'1.03.11.1.02','Penyelenggaraan Sistem Informasi Jasa Konstruksi (SIPJAKI) Cakupan Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(49,19,'1.03.12.1.01','Penetapan Rencana Tata Ruang Wilayah dan Rencana Rinci Tata Ruang Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(50,19,'1.03.12.1.02','Koordinasi dan Sinkronisasi Perencanaan Tata Ruang',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(51,19,'1.03.12.1.03','Koordinasi dan Sinkronisasi Pemanfataan Ruang Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(52,19,'1.03.12.1.04','Koordinasi dan Sinkronisasi Pengendalian Pemanfataan Ruang Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(53,20,'1.04.01.1.01','Perencanaan  Penganggaran  dan Evaluasi Kinerja Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(54,20,'1.04.01.1.02','Administrasi Keuangan Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(55,20,'1.04.01.1.03','Administrasi Barang Milik Daerah padaPerangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(56,20,'1.04.01.1.05','Administrasi Kepegawaian Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(57,20,'1.04.01.1.06','Administrasi Umum Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(58,20,'1.04.01.1.07','Pengadaan Barang Milik Daerah PenunjangUrusan Pemerintah Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(59,20,'1.04.01.1.08','Penyediaan Jasa Penunjang UrusanPemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(60,20,'1.04.01.1.09','Pemeliharaan Barang Milik Daerah Penunjang Urusan Pemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(61,21,'1.04.03.1.01','Penataan Kawasan Permukiman Kumuh dengan Luas 10 (Sepuluh) Ha sampai dengan di Bawah 15 (Lima Belas) Ha',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(62,21,'1.04.03.1.02','Peningkatan Kualitas Kawasan Permukiman Kumuh dengan Luas 10 (Sepuluh) Ha sampai dengan di Bawah 15 (Lima Belas) Ha',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(63,22,'1.04.05.1.01','Urusan Penyelenggaraan PSU Permukiman',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(64,23,'1.05.01.1.01','Perencanaan  Penganggaran  dan Evaluasi Kinerja Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(65,23,'1.05.01.1.02','Administrasi Keuangan Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(66,23,'1.05.01.1.03','Administrasi Barang Milik Daerah padaPerangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(67,23,'1.05.01.1.05','Administrasi Kepegawaian Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(68,23,'1.05.01.1.06','Administrasi Umum Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(69,23,'1.05.01.1.07','Pengadaan Barang Milik Daerah PenunjangUrusan Pemerintah Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(70,23,'1.05.01.1.08','Penyediaan Jasa Penunjang UrusanPemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(71,23,'1.05.01.1.09','Pemeliharaan Barang Milik Daerah Penunjang Urusan Pemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(72,23,'1.05.02.1.01','Penanganan Gangguan Ketenteraman dan Ketertiban Umum Lintas Daerah Kabupaten/Kota dalam 1 (Satu) Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(73,23,'1.05.02.1.02','Penegakan Peraturan Daerah Provinsi dan Peraturan Gubernur',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(74,23,'1.05.02.1.03','Pembinaan Penyidik Pegawai Negeri Sipil (PPNS) Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(75,23,'1.05.03.1.01','Pelayanan Informasi Rawan Bencana Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(76,23,'1.05.03.1.02','Pelayanan Pencegahan dan Kesiapsiagaan Terhadap Bencana',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(77,23,'1.05.03.1.03','Pelayanan Penyelamatan dan Evakuasi Korban Bencana',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(78,23,'1.05.03.1.04','Penataan Sistem Dasar Penanggulangan Bencana',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(79,24,'1.06.01.1.01','Perencanaan  Penganggaran  dan Evaluasi Kinerja Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(80,24,'1.06.01.1.03','Administrasi Barang Milik Daerah padaPerangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(81,24,'1.06.01.1.05','Administrasi Kepegawaian Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(82,24,'1.06.01.1.06','Administrasi Umum Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(83,24,'1.06.01.1.08','Penyediaan Jasa Penunjang UrusanPemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(84,24,'1.06.01.1.09','Pemeliharaan Barang Milik Daerah Penunjang Urusan Pemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(85,24,'1.06.02.1.01','Penerbitan Izin Pengumpulan Sumbangan Lintas Daerah Kabupaten/Kota dalam 1 (Satu) Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(86,24,'1.06.02.1.02','Pemberdayaan Potensi Sumber Kesejahteraan Sosial Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(87,25,'1.06.03.1.01','Pemulangan Warga Negara Migran Korban Tindak Kekerasan dari Titik Debarkasi di Daerah Provinsi untuk Dipulangkan ke Daerah Kabupaten/Kota Asal',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(88,26,'1.06.04.1.01','Rehabilitasi Sosial Dasar Penyandang Disabilitas TerlAntar di dalam Panti',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(89,26,'1.06.04.1.02','Rehabilitasi Sosial Dasar Anak TerlAntar di dalam Panti',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(90,26,'1.06.04.1.03','Rehabilitasi Sosial Dasar Lanjut Usia Terlantar di dalam Panti',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(91,26,'1.06.04.1.04','Rehabilitasi Sosial Dasar Gelandangan dan Pengemis di dalam Panti',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(92,26,'1.06.04.1.05','Rehabilitasi Sosial bagi Penyandang Masalah Kesejahteraan Sosial (PMKS) Lainnya di Luar HIV/AIDS dan NAPZA di dalam Panti',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(93,28,'1.06.06.1.01','Perlindungan Sosial Korban Bencana Alam dan Sosial Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(94,29,'1.06.07.1.01','Pengelolaan Taman Makam Pahlawan Nasional Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(95,30,'2.07.01.1.01','Perencanaan  Penganggaran  dan Evaluasi Kinerja Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(96,30,'2.07.01.1.02','Administrasi Keuangan Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(97,30,'2.07.01.1.03','Administrasi Barang Milik Daerah padaPerangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(98,30,'2.07.01.1.05','Administrasi Kepegawaian Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(99,30,'2.07.01.1.06','Administrasi Umum Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(100,30,'2.07.01.1.07','Pengadaan Barang Milik Daerah PenunjangUrusan Pemerintah Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(101,30,'2.07.01.1.08','Penyediaan Jasa Penunjang UrusanPemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(102,30,'2.07.01.1.09','Pemeliharaan Barang Milik Daerah Penunjang Urusan Pemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(103,31,'2.07.02.1.01','Penyusunan Rencana Tenaga Kerja (RTK)',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(104,32,'2.07.03.1.01','Pelaksanaan Latihan Kerja Berdasarkan Klaster Kompetensi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(105,32,'2.07.03.1.02','Pelaksanaan Akreditasi Lembaga Pelatihan Kerja',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(106,32,'2.07.03.1.03','Konsultansi Produktivitas pada Perusahaan Menengah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(107,32,'2.07.03.1.04','Pengukuran Produktivitas Tingkat Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(108,33,'2.07.04.1.01','Pelayanan Antar Kerja Lintas Daerah Kabupaten/Kota',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(109,33,'2.07.04.1.03','Pengelolaan Informasi Pasar Kerja',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(110,33,'2.07.04.1.04','Pelindungan PMI (Pra dan Purna Penempatan) di Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(111,34,'2.07.05.1.01','Pengesahan Peraturan Perusahaan dan Pendaftaran Perjanjian Kerja Bersama untuk yang Mempunyai Wilayah Kerja lebih dari 1 (satu) Kabupaten/Kota',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(112,34,'2.07.05.1.02','Pencegahan dan Penyelesaian Perselisihan Hubungan Industrial  Mogok Kerja  dan Penutupan Perusahaan yang Berakibat/Berdampak pada Kepentingan di 1 (satu) Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(113,34,'2.07.05.1.03','Penetapan Upah Minimum Provinsi (UMP)  Upah Minimum Sektoral Provinsi (UMSP)  Upah Minimum Kabupaten/Kota (UMK)  dan Upah Minimum Sektoral Kabupaten/Kota (UMSK)',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(114,35,'2.07.06.1.01','Penyelenggaraan Pengawasan Ketenagakerjaan',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(115,36,'2.08.01.1.01','Perencanaan  Penganggaran  dan Evaluasi Kinerja Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(116,36,'2.08.01.1.02','Administrasi Keuangan Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(117,36,'2.08.01.1.03','Administrasi Barang Milik Daerah padaPerangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(118,36,'2.08.01.1.05','Administrasi Kepegawaian Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(119,36,'2.08.01.1.06','Administrasi Umum Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(120,36,'2.08.01.1.07','Pengadaan Barang Milik Daerah PenunjangUrusan Pemerintah Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(121,36,'2.08.01.1.08','Penyediaan Jasa Penunjang UrusanPemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(122,36,'2.08.01.1.09','Pemeliharaan Barang Milik Daerah Penunjang Urusan Pemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(123,37,'2.08.02.1.01','Pelembagaan Pengarusutamaan Gender (PUG) pada Lembaga Pemerintah Kewenangan Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(124,37,'2.08.02.1.02','Pemberdayaan Perempuan Bidang Politik  Hukum  Sosial  dan Ekonomi pada Organisasi KeMasyarakatan Kewenangan Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(125,37,'2.08.02.1.03','Penguatan dan Pengembangan Lembaga Penyedia Layanan Pemberdayaan Perempuan Kewenangan Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(126,38,'2.08.03.1.01','Pencegahan Kekerasan terhadap Perempuan yang melibatkan para Pihak Lingkup Daerah Provinsi dan Lintas Daerah Kabupaten/Kota',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(127,38,'2.08.03.1.02','Penyediaan Layanan Rujukan Lanjutan bagi Perempuan Korban Kekerasan yang memerlukan Koordinasi Tingkat Daerah Provinsi dan Lintas Daerah Kabupaten/Kota',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(128,38,'2.08.03.1.03','Penguatan dan Pengembangan Lembaga Penyedia Layanan Perlindungan Perempuan Kewenangan Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(129,40,'2.08.05.1.01','Pengumpulan  Pengolahan Analisis dan Penyajian Data Gender dan Anak dalam Kelembagaan Data di Tingkat Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(130,41,'2.08.06.1.02','Penguatan dan Pengembangan Lembaga Penyedia Layanan Peningkatan Kualitas Hidup Anak Kewenangan Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(131,42,'2.08.07.1.01','Pencegahan Kekerasan terhadap Anak yang Melibatkan para Pihak Lingkup Daerah Provinsi dan Lintas Daerah Kabupaten/Kota',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(132,42,'2.08.07.1.03','Penguatan dan Pengembangan Lembaga Penyedia Layanan bagi Anak yang Memerlukan Perlindungan Khusus Tingkat Daerah Provinsi dan Lintas Daerah Kabupaten/Kota',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(133,43,'2.09.03.1.04','Promosi Pencapaian Target Konsumsi Pangan Perkapita/Tahun sesuai dengan Angka Kecukupan Gizi Melalui Media Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(134,43,'2.10.06.1.01','Penetapan Subyek dan Obyek Redistribusi Tanah Lintas Daerah Kabupaten/Kota dalam 1 (satu) Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(135,44,'2.10.10.1.01','Perencanaan Penggunaan Tanah yang Hamparannya Lintas Daerah Kabupaten/Kota dalam 1 (satu) Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(136,45,'2.11.01.1.01','Perencanaan  Penganggaran  dan Evaluasi Kinerja Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(137,45,'2.11.01.1.02','Administrasi Keuangan Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(138,45,'2.11.01.1.03','Administrasi Barang Milik Daerah padaPerangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(139,45,'2.11.01.1.06','Administrasi Umum Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(140,45,'2.11.01.1.07','Pengadaan Barang Milik Daerah PenunjangUrusan Pemerintah Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(141,45,'2.11.01.1.08','Penyediaan Jasa Penunjang UrusanPemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(142,45,'2.11.01.1.09','Pemeliharaan Barang Milik Daerah Penunjang Urusan Pemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(143,45,'2.11.01.1.10','Peningkatan Pelayanan BLUD',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(144,46,'2.11.02.1.01','Rencana Perlindungan dan Pengelolaan Lingkungan Hidup (RPPLH) Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(145,46,'2.11.02.1.02','Penyelenggaraan Kajian Lingkungan Hidup Strategis (KLHS) Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(146,47,'2.11.03.1.01','Pencegahan Pencemaran dan/atau Kerusakan Lingkugan Hidup',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(147,47,'2.11.03.1.02','Penanggulangan Pencemaran dan/atau Kerusakan Lingkungan Hidup',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(148,47,'2.11.03.1.03','Pemulihan Pencemaran dan/atau Kerusakan Lingkungan Hidup',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(149,48,'2.11.04.1.01','Pengelolaan Keanekaragaman Hayati Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(150,49,'2.11.05.1.01','Pengumpulan Limbah B3 Lintas Daerah Kabupaten/Kota dalam 1 (satu) Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(151,50,'2.11.06.1.01','Pembinaan dan Pengawasan Izin Lingkungan dan Izin PPLH yang diterbitkan oleh Pemerintah Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(152,51,'2.11.08.1.01','Penyelenggaraan Pendidikan  Pelatihan  dan Penyuluhan Lingkungan Hidup untuk Lembaga KeMasyarakatan Tingkat Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(153,52,'2.11.09.1.01','Pemberian Penghargaan Lingkungan Hidup Tingkat Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(154,53,'2.11.10.1.01','Penyelesaian Pengaduan Masyarakat di Bidang Perlindungan dan Pengelolaan Lingkungan Hidup (PPLH) Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(155,54,'2.11.11.1.01','Penanganan Sampah di TPA/TPST Regional',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(156,55,'2.12.01.1.01','Perencanaan  Penganggaran  dan Evaluasi Kinerja Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(157,55,'2.12.01.1.02','Administrasi Keuangan Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(158,55,'2.12.01.1.03','Administrasi Barang Milik Daerah padaPerangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(159,55,'2.12.01.1.05','Administrasi Kepegawaian Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(160,55,'2.12.01.1.06','Administrasi Umum Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(161,55,'2.12.01.1.07','Pengadaan Barang Milik Daerah PenunjangUrusan Pemerintah Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(162,55,'2.12.01.1.08','Penyediaan Jasa Penunjang UrusanPemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(163,55,'2.12.01.1.09','Pemeliharaan Barang Milik Daerah Penunjang Urusan Pemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(164,56,'2.12.02.1.01','Pelayanan Pendaftaran Kependudukan',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(165,56,'2.12.02.1.02','Penyelenggaraan Pendaftaran Kependudukan',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(166,56,'2.12.02.1.03','Pembinaan dan Pengawasan Penyelenggaraan Pendaftaran Kependudukan',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(167,57,'2.12.03.1.01','Pelayanan Pencatatan Sipil',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(168,57,'2.12.03.1.02','Penyelenggaraan Pencatatan Sipil di Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(169,57,'2.12.03.1.03','Pemberian Konsultasi Penyelenggaraan Pencatatan Sipil',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(170,58,'2.12.04.1.02','Penyelenggaraan Pengelolaan Informasi Administrasi Kependudukan Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(171,58,'2.12.04.1.03','Pembinaan dan Pengawasan Pengelolaan Informasi Administrasi Kependudukan Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(172,59,'2.12.05.1.01','Penyediaan Profil Kependudukan',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(173,60,'2.13.01.1.01','Perencanaan  Penganggaran  dan Evaluasi Kinerja Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(174,60,'2.13.01.1.02','Administrasi Keuangan Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(175,60,'2.13.01.1.03','Administrasi Barang Milik Daerah padaPerangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(176,60,'2.13.01.1.05','Administrasi Kepegawaian Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(177,60,'2.13.01.1.06','Administrasi Umum Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(178,60,'2.13.01.1.08','Penyediaan Jasa Penunjang UrusanPemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(179,60,'2.13.01.1.09','Pemeliharaan Barang Milik Daerah Penunjang Urusan Pemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(180,61,'2.13.03.1.01','Fasilitasi Kerja Sama antar desa yang Menjadi Kewenangan Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(181,61,'2.13.04.1.01','Pembinaan dan Pengawasan Penyelenggaraan Pemerintahan Desa',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(182,61,'2.13.05.1.01','Pemberdayaan Lembaga keMasyarakatan yang Bergerak di Bidang Pemberdayaan Desa dan Lembaga Adat Tingkat Daerah Provinsi serta Pemberdayaan Masyarakat Hukum Adat yang Masyarakat Pelakunya Hukum Adat yang Sama Berada di Lintas Daerah Kabupaten/Kota',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(183,62,'2.14.02.1.01','Pemaduan dan Sinkronisasi Kebijakan Pemerintah Pusat dengan Pemerintah Daerah Provinsi dalam rangka Pengendalian Kuantitas Penduduk',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(184,63,'2.14.03.1.01','Pengembangan Desain Program  Pengelolaan dan Pelaksanaan Advokasi  Komunikasi  Informasi dan Edukasi (KIE) Pengendalian Penduduk dan Keluarga Berencana (KB) Sesuai Kearifan Budaya Lokal',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(185,64,'2.14.04.1.01','Pengelolaan Pelaksanaan Desain Program Pembangunan Keluarga Melalui Pembinaan Ketahanan dan Kesejahteraan Keluarga',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(186,64,'2.14.04.1.02','Pemberdayaan dan Peningkatan Peran serta Organisasi KeMasyarakatan Tingkat Daerah Provinsi dalam Pembangunan Keluarga Melalui Pembinaan Ketahanan dan Kesejahteraan Keluarga',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(187,65,'2.15.01.1.01','Perencanaan  Penganggaran  dan Evaluasi Kinerja Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(188,65,'2.15.01.1.02','Administrasi Keuangan Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(189,65,'2.15.01.1.03','Administrasi Barang Milik Daerah padaPerangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(190,65,'2.15.01.1.05','Administrasi Kepegawaian Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(191,65,'2.15.01.1.07','Pengadaan Barang Milik Daerah PenunjangUrusan Pemerintah Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(192,65,'2.15.01.1.08','Penyediaan Jasa Penunjang UrusanPemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(193,65,'2.15.01.1.09','Pemeliharaan Barang Milik Daerah Penunjang Urusan Pemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(194,66,'2.15.02.1.01','Penetapan Rencana Induk Jaringan LLAJ Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(195,66,'2.15.02.1.02','Penyediaan Perlengkapan Jalan di Jalan Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(196,66,'2.15.02.1.03','Pengelolaan Terminal Penumpang Tipe B',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(197,66,'2.15.02.1.05','Pelaksanaan Manajemen dan Rekayasa Lalu Lintas untuk Jaringan Jalan Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(198,66,'2.15.02.1.07','Audit dan Inspeksi Keselamatan LLAJ di Jalan',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(199,66,'2.15.02.1.09','Penetapan Kawasan Perkotaan untuk Pelayanan Angkutan Perkotaan yang Melampaui Batas 1 (satu) Daerah Kabupaten/Kota dalam 1 (satu) Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(200,66,'2.15.02.1.13','Penerbitan Izin Penyelenggaraan Angkutan Orang dalam Trayek Lintas Daerah Kabupaten/Kota dalam 1 (satu) Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(201,67,'2.15.03.1.06','Penerbitan Izin Usaha Jasa Terkait Berupa Bongkar Muat Barang  Jasa Pengurusan Transportasi  Angkutan Perairan Pelabuhan  Penyewaan Peralatan Angkutan Laut atau Peralatan Jasa Terkait Dengan Angkutan Laut  Tally Mandiri  dan Depo Peti Kemas',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(202,67,'2.15.03.1.09','Pembangunan  Penerbitan Izin Pembangunan dan Pengoperasian Pelabuhan Pengumpan Regional',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(203,67,'2.15.03.1.11','Penerbitan Izin Usaha untuk Badan Usaha Pelabuhan di Pelabuhan Pengumpan Regional',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(204,68,'2.15.05.1.06','Penetapan Jaringan Pelayanan Perkeretaapian pada Jaringan Jalur Perkeretaapian Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(205,69,'2.16.01.1.01','Perencanaan  Penganggaran  dan Evaluasi Kinerja Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(206,69,'2.16.01.1.02','Administrasi Keuangan Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(207,69,'2.16.01.1.03','Administrasi Barang Milik Daerah padaPerangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(208,69,'2.16.01.1.05','Administrasi Kepegawaian Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(209,69,'2.16.01.1.06','Administrasi Umum Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(210,69,'2.16.01.1.07','Pengadaan Barang Milik Daerah PenunjangUrusan Pemerintah Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(211,69,'2.16.01.1.08','Penyediaan Jasa Penunjang UrusanPemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(212,69,'2.16.01.1.09','Pemeliharaan Barang Milik Daerah Penunjang Urusan Pemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(213,70,'2.16.02.1.01','Pengelolaan Informasi dan Komunikasi Publik Pemerintah Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(214,71,'2.16.03.1.02','Pengelolaan E-government di Lingkup Pemerintah Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(215,72,'2.17.01.1.01','Perencanaan  Penganggaran  dan Evaluasi Kinerja Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(216,72,'2.17.01.1.02','Administrasi Keuangan Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(217,72,'2.17.01.1.03','Administrasi Barang Milik Daerah padaPerangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(218,72,'2.17.01.1.05','Administrasi Kepegawaian Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(219,72,'2.17.01.1.06','Administrasi Umum Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(220,72,'2.17.01.1.07','Pengadaan Barang Milik Daerah PenunjangUrusan Pemerintah Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(221,72,'2.17.01.1.08','Penyediaan Jasa Penunjang UrusanPemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(222,72,'2.17.01.1.09','Pemeliharaan Barang Milik Daerah Penunjang Urusan Pemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(223,73,'2.17.02.1.01','Penerbitan Izin Usaha Simpan Pinjam untuk Koperasi dengan Wilayah Keanggotaan Lintas Daerah Kabupaten/Kota dalam 1 (satu) Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(224,73,'2.17.02.1.02','Penerbitan Izin Pembukaan Kantor Cabang  Cabang Pembantu dan Kantor Kas Koperasi Simpan Pinjam untuk Koperasi dengan Wilayah Keanggotaan Lintas Daerah Kabupaten/Kota dalam 1 (satu) Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(225,74,'2.17.03.1.01','Pemeriksaan dan Pengawasan Koperasi yang Wilayah Keanggotaannya Lintas Daerah Kabupaten/Kota dalam 1 (satu) Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(226,75,'2.17.04.1.01','Penilaian Kesehatan Koperasi Simpan Pinjam/Unit Simpan Pinjam Koperasi yang Wilayah Keanggotaanya Lintas Daerah Kabupaten/Kota dalam 1 (satu) Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(227,75,'2.17.05.1.01','Pendidikan dan Latihan Perkoperasian bagi Koperasi yang Wilayah Lintas Daerah Kabupaten/Kota dalam 1 (satu) Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(228,76,'2.17.06.1.01','Pemberdayaan dan Perlindungan Koperasi yang Keanggotaannya Lintas Daerah Kabupaten/Kota dalam 1 (satu) Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(229,76,'2.17.07.1.01','Pemberdayaan Usaha Kecil yang dilakukan Melalui Pendataan  Kemitraan  Kemudahan Perijinan  Penguatan Kelembagaan dan Koordinasi Dengan Para Pemangku Kepentingan',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(230,77,'2.17.08.1.01','Pengembangan Usaha Kecil dengan Orientasi Peningkatan Skala Usaha Menjadi Usaha Menengah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(231,78,'2.18.01.1.01','Perencanaan  Penganggaran  dan Evaluasi Kinerja Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(232,78,'2.18.01.1.02','Administrasi Keuangan Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(233,78,'2.18.01.1.03','Administrasi Barang Milik Daerah padaPerangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(234,78,'2.18.01.1.05','Administrasi Kepegawaian Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(235,78,'2.18.01.1.06','Administrasi Umum Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(236,78,'2.18.01.1.07','Pengadaan Barang Milik Daerah PenunjangUrusan Pemerintah Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(237,78,'2.18.01.1.08','Penyediaan Jasa Penunjang UrusanPemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(238,78,'2.18.01.1.09','Pemeliharaan Barang Milik Daerah Penunjang Urusan Pemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(239,79,'2.18.02.1.01','Penetapan Pemberian Fasilitas/Insentif dibidang Penanaman Modal yang Menjadi Kewenangan Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(240,79,'2.18.02.1.02','Pembuatan Peta Potensi Investasi Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(241,79,'2.18.03.1.01','Penyelenggaraan Promosi Penanaman Modal yang Menjadi Kewenangan Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(242,80,'2.18.04.1.02','Penanaman Modal yang Menurut Ketentuan Peraturan Perundangan-Undangan Menjadi Kewenangan Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(243,81,'2.18.05.1.01','Pengendalian Pelaksanaan Penanaman Modal yang Menjadi Kewenangan Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(244,81,'2.18.06.1.01','Urusan Pengelolaan Data dan Informasi Perizinan dan Non Perizinan Penanaman Modal yang Terintegrasi pada Tingkat Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(245,82,'2.19.01.1.01','Perencanaan  Penganggaran  dan Evaluasi Kinerja Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(246,82,'2.19.01.1.02','Administrasi Keuangan Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(247,82,'2.19.01.1.05','Administrasi Kepegawaian Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(248,82,'2.19.01.1.06','Administrasi Umum Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(249,82,'2.19.01.1.07','Pengadaan Barang Milik Daerah PenunjangUrusan Pemerintah Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(250,82,'2.19.01.1.08','Penyediaan Jasa Penunjang UrusanPemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(251,82,'2.19.01.1.09','Pemeliharaan Barang Milik Daerah Penunjang Urusan Pemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(252,83,'2.19.02.1.01','Penyadaran  Pemberdayaan  dan Pengembangan Pemuda dan Kepemudaan Kewenangan Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(253,83,'2.19.02.1.02','Pemberdayaan dan Pengembangan Organisasi Kepemudaan Tingkat Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(254,84,'2.19.03.1.01','Pembinaan dan Pengembangan Olahraga Pendidikan pada Jenjang Pendidikan yang Menjadi Kewenangan Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(255,84,'2.19.03.1.02','Penyelenggaraan Kejuaraan Olahraga',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(256,84,'2.19.03.1.04','Pembinaan dan Pengembangan Organisasi Olahraga',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(257,85,'2.19.04.1.01','Pembinaan dan Pengembangan Organisasi Kepramukaan',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(258,86,'2.20.02.1.01','Penyelenggaraan Statistik Sektoral di Lingkup Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(259,87,'2.21.02.1.01','Penyelenggaraan Persandian untuk Pengamanan Informasi Pemerintah Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(260,87,'2.21.02.1.02','Penetapan Pola Hubungan Komunikasi Sandi antar Perangkat Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(261,88,'2.22.02.1.01','Pengelolaan Kebudayaan yang Masyarakat Pelakunya Lintas Daerah Kabupaten/Kota dalam 1 (satu) Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(262,89,'2.22.03.1.01','Pembinaan Kesenian yang Masyarakat Pelakunya Lintas Daerah Kabupaten/Kota',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(263,90,'2.22.04.1.01','Pembinaan Sejarah Lokal Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(264,91,'2.22.05.1.02','Pengelolaan Cagar Budaya Peringkat Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(265,93,'2.23.01.1.01','Perencanaan  Penganggaran  dan Evaluasi Kinerja Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(266,93,'2.23.01.1.02','Administrasi Keuangan Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(267,93,'2.23.01.1.03','Administrasi Barang Milik Daerah padaPerangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(268,93,'2.23.01.1.05','Administrasi Kepegawaian Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(269,93,'2.23.01.1.06','Administrasi Umum Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(270,93,'2.23.01.1.07','Pengadaan Barang Milik Daerah PenunjangUrusan Pemerintah Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(271,93,'2.23.01.1.08','Penyediaan Jasa Penunjang UrusanPemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(272,93,'2.23.01.1.09','Pemeliharaan Barang Milik Daerah Penunjang Urusan Pemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(273,94,'2.23.02.1.01','Pengelolaan Perpustakaan Tingkat Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(274,94,'2.23.02.1.02','Pembudayaan Gemar Membaca Tingkat Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(275,95,'2.23.03.1.01','Pelestarian Karya Cetak dan Karya Rekam Koleksi Daerah di Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(276,95,'2.23.03.1.02','Penerbitan Katalog Induk Daerah dan Bibliografi Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(277,95,'2.23.03.1.03','Pelestarian Naskah Kuno Milik Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(278,96,'2.24.02.1.01','Pengelolaan Arsip Dinamis Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(279,96,'2.24.02.1.02','Pengelolaan Arsip Statis Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(280,96,'2.24.02.1.03','Pengelolaan Simpul Jaringan dalam Sistem Informasi Kearsipan Nasional Tingkat Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(281,97,'3.25.01.1.01','Perencanaan  Penganggaran  dan Evaluasi Kinerja Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(282,97,'3.25.01.1.02','Administrasi Keuangan Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(283,97,'3.25.01.1.03','Administrasi Barang Milik Daerah padaPerangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(284,97,'3.25.01.1.05','Administrasi Kepegawaian Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(285,97,'3.25.01.1.06','Administrasi Umum Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(286,97,'3.25.01.1.07','Pengadaan Barang Milik Daerah PenunjangUrusan Pemerintah Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(287,97,'3.25.01.1.08','Penyediaan Jasa Penunjang UrusanPemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(288,98,'3.25.02.1.01','Pengelolaan Ruang Laut Sampai Dengan 12 Mil di Luar Minyak dan Gas Bumi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(289,98,'3.25.02.1.02','Penerbitan Izin Pemanfaatan Ruang Laut di Bawah 12 Mil di Luar Minyak dan Gas Bumi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(290,98,'3.25.02.1.03','Pemberdayaan Masyarakat Pesisir dan Pulau-Pulau Kecil',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(291,99,'3.25.03.1.01','Pengelolaan Penangkapan Ikan di Wilayah Laut Sampai Dengan 12 Mil',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(292,99,'3.25.03.1.02','Pengelolaan Penangkapan Ikan di Wilayah Sungai  Danau  Waduk  Rawa  dan Genangan Air Lainnya yang dapat Diusahakan Lintas Kabupaten/Kota dalam 1 (Satu) Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(293,99,'3.25.03.1.03','Penerbitan Izin Usaha Perikanan Tangkap untuk Kapal Perikanan Berukuran di atas 10 GT sampai dengan 30 GT',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(294,99,'3.25.03.1.06','Penetapan Lokasi Pembangunan serta Pengelolaan Pelabuhan Perikanan Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(295,99,'3.25.03.1.09','Pendaftaran Kapal Perikanan di atas 10 GT sampai dengan 30 GT',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(296,100,'3.25.04.1.05','Pengelolaan Pembudidayaan Ikan di Laut',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(297,100,'3.25.04.1.06','Pengelolaan Pembudidayaan Ikan di Perairan Darat',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(298,101,'3.25.05.1.01','Pengawasan Sumber Daya Kelautan dan Perikanan sampai dengan 12 Mil',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(299,101,'3.25.05.1.02','Pengawasan Sumber Daya Perikanan di Wilayah Sungai  Danau  Waduk  Rawa  dan Genangan Air Lainnya yang Dapat Diusahakan Lintas Kabupaten/Kota dalam 1 (Satu) Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(300,102,'3.25.06.1.01','Penerbitan Izin Usaha Pemasaran dan Pengolahan Hasil Perikanan Lintas Daerah Kabupaten/Kota dalam 1 (Satu) Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(301,102,'3.25.06.1.03','Penyediaan dan Penyaluran Bahan Baku Industri Pengolahan Ikan Lintas Daerah Kabupaten/Kota dalam 1 (Satu) Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(302,103,'3.26.01.1.01','Perencanaan  Penganggaran  dan Evaluasi Kinerja Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(303,103,'3.26.01.1.02','Administrasi Keuangan Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(304,103,'3.26.01.1.03','Administrasi Barang Milik Daerah padaPerangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(305,103,'3.26.01.1.05','Administrasi Kepegawaian Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(306,103,'3.26.01.1.06','Administrasi Umum Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(307,103,'3.26.01.1.07','Pengadaan Barang Milik Daerah PenunjangUrusan Pemerintah Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(308,103,'3.26.01.1.08','Penyediaan Jasa Penunjang UrusanPemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(309,103,'3.26.01.1.09','Pemeliharaan Barang Milik Daerah Penunjang Urusan Pemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(310,104,'3.26.02.1.01','Pengelolaan Daya Tarik Wisata Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(311,104,'3.26.02.1.03','Pengelolaan Destinasi Pariwisata Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(312,104,'3.26.02.1.04','Penetapan Tanda Daftar Usaha Pariwisata Lintas Daerah Kabupaten/Kota dalam 1 (Satu) Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(313,105,'3.26.03.1.01','Pemasaran Pariwisata Dalam dan Luar Negeri Daya Tarik  Destinasi dan Kawasan Strategis Pariwisata Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(314,106,'3.26.04.1.01','Penyediaan Sarana dan Prasarana Kota Kreatif',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(315,106,'3.26.04.1.02','Pengembangan Ekosistem Ekonomi Kreatif ',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(316,107,'3.26.05.1.01','Pelaksanaan Peningkatan Kapasitas Sumber Daya Manusia Pariwisata dan Ekonomi Kreatif Tingkat Lanjutan',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(317,107,'3.26.05.1.02','Pengembangan Kapasitas Pelaku Ekonomi Kreatif',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(318,108,'3.27.01.1.01','Perencanaan  Penganggaran  dan Evaluasi Kinerja Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(319,108,'3.27.01.1.02','Administrasi Keuangan Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(320,108,'3.27.01.1.03','Administrasi Barang Milik Daerah padaPerangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(321,108,'3.27.01.1.04','Administrasi Pendapatan Daerah Kewenangan Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(322,108,'3.27.01.1.05','Administrasi Kepegawaian Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(323,108,'3.27.01.1.06','Administrasi Umum Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(324,108,'3.27.01.1.08','Penyediaan Jasa Penunjang UrusanPemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(325,108,'3.27.01.1.09','Pemeliharaan Barang Milik Daerah Penunjang Urusan Pemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(326,109,'3.27.02.1.01','Pengawasan Peredaran Sarana Pertanian',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(327,109,'3.27.02.1.02','Pengawasan Mutu  Penyediaan dan Peredaran Benih Tanaman',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(328,109,'3.27.02.1.04','Peningkatan Ketersediaan dan Mutu Benih/Bibit Ternak dan Tanaman Pakan Ternak  Bahan Pakan  serta Pakan Kewenangan Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(329,109,'3.27.02.1.05','Pengendalian dan Pengawasan Penyediaan dan Peredaran Benih/Bibit Ternak dan Tanaman Pakan Ternak serta Pakan Kewenangan Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(330,109,'3.27.02.1.06','Pengawasan Peredaran Obat Hewan di Tingkat Distributor',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(331,110,'3.27.03.1.01','Penataan Prasarana Pertanian',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(332,111,'3.27.04.1.01','Penjaminan Kesehatan Hewan  Penutupan dan Pembukaan Daerah Wabah Penyakit Hewan Menular Lintas Daerah Kabupaten/Kota dalam 1 (satu) Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(333,111,'3.27.04.1.02','Pengawasan Pemasukan dan Pengeluaran Hewan dan Produk Hewan Lintas Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(334,111,'3.27.04.1.03','Penerapan Persyaratan Teknis Sertifikasi Zona/Kompartemen Bebas Penyakit dan Unit Usaha Produk Hewan',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(335,111,'3.27.04.1.04','Sertifikasi Persyaratan Teknis Kesehatan Masyarakat Veteriner',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(336,111,'3.27.04.1.05','Kesejahteraan Hewan',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(337,112,'3.27.05.1.01','Pengendalian dan Penanggulangan Bencana Pertanian Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(338,113,'3.27.06.1.01','Penerbitan Izin Usaha Pertanian yang Kegiatan Usahanya dalam Daerah Kabupaten/Kota',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(339,114,'3.27.07.1.02','Pengembangan Penerapan Penyuluhan Pertanian',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(340,114,'3.27.07.1.03','Pengembangan Kapasitas Kelembagaan Ekonomi Petani Berbasis Kawasan',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(341,115,'3.28.01.1.01','Perencanaan  Penganggaran  dan Evaluasi Kinerja Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(342,115,'3.28.01.1.02','Administrasi Keuangan Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(343,115,'3.28.01.1.03','Administrasi Barang Milik Daerah padaPerangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(344,115,'3.28.01.1.05','Administrasi Kepegawaian Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(345,115,'3.28.01.1.06','Administrasi Umum Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(346,115,'3.28.01.1.07','Pengadaan Barang Milik Daerah PenunjangUrusan Pemerintah Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(347,115,'3.28.01.1.08','Penyediaan Jasa Penunjang UrusanPemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(348,115,'3.28.01.1.09','Pemeliharaan Barang Milik Daerah Penunjang Urusan Pemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(349,116,'3.28.03.1.01','Pengelolaan Rencana Tata Hutan Kesatuan Pengelolaan Hutan (KPH) Kewenangan Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(350,116,'3.28.03.1.02','Rencana Pengelolaan Kesatuan Pengelolaan Hutan kecuali pada Kesatuan Pengelolaan Hutan Konservasi (KPHK)',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(351,116,'3.28.03.1.03','Pemanfaatan Hutan di Kawasan Hutan Produksi dan Hutan Lindung',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(352,116,'3.28.03.1.04','Pelaksanaan Rehabilitasi di Luar Kawasan Hutan Negara',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(353,116,'3.28.03.1.05','Pelaksanaan Perlindungan Hutan di Hutan Lindung dan Hutan Produksi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(354,116,'3.28.03.1.06','Pelaksanaan Pengolahan Hasil Hutan Bukan Kayu (HHBK)',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(355,116,'3.28.03.1.07','Pelaksanaan Pengolahan Hasil Hutan Kayu dengan Kapasitas Produksi <6000 m3/Tahun',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(356,116,'3.28.03.1.09','Perbenihan Tanaman Hutan',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(357,117,'3.28.04.1.01','Pengelolaan Taman Hutan Raya (TAHURA) Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(358,117,'3.28.04.1.02','Perlindungan Tumbuhan dan Satwa Liar yang Tidak Dilindungi dan/atau Tidak Masuk dalam Lampiran (Appendix) CITES (Convension On International Trade In Endangered Species) untuk Kewenangan Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(359,117,'3.28.04.1.03','Pengelolaan Kawasan Bernilai Ekosistem Penting  Daerah Penyangga Kawasan Suaka Alam dan Kawasan Pelestarian Alam',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(360,118,'3.28.05.1.01','Pelaksanaan Penyuluhan Kehutanan Provinsi dan Pemberdayaan Masyarakat di Bidang Kehutanan',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(361,119,'3.28.06.1.01','Pelaksanaan Pengelolaan DAS Lintas Daerah Kabupaten/Kota dan dalam Daerah Kabupaten/Kota dalam 1 (satu) Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(362,120,'3.29.01.1.01','Perencanaan  Penganggaran  dan Evaluasi Kinerja Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(363,120,'3.29.01.1.03','Administrasi Barang Milik Daerah padaPerangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(364,120,'3.29.01.1.05','Administrasi Kepegawaian Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(365,120,'3.29.01.1.06','Administrasi Umum Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(366,120,'3.29.01.1.07','Pengadaan Barang Milik Daerah PenunjangUrusan Pemerintah Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(367,120,'3.29.01.1.08','Penyediaan Jasa Penunjang UrusanPemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(368,120,'3.29.01.1.09','Pemeliharaan Barang Milik Daerah Penunjang Urusan Pemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(369,121,'3.29.02.1.01','Penetapan Zona Konservasi Air Tanah pada Cekungan Air Tanah dalam Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(370,121,'3.29.02.1.03','Penetapan Nilai Perolehan Air Tanah dalam Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(371,122,'3.29.03.1.01','Penetapan Wilayah Izin Usaha Pertambangan Mineral Bukan Logam dan Batuan dalam 1 (satu) Daerah Provinsi dan Wilayah Laut sampai dengan 12 Mil',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(372,122,'3.29.03.1.03','Penatausahaan Izin Usaha Pertambangan Mineral Bukan Logam dan Batuan dalam rangka Penanaman Modal Dalam Negeri pada Wilayah Izin Usaha Pertambangan Daerah yang Berada dalam 1 (satu) Daerah Provinsi termasuk Wilayah Laut sampai dengan 12 Mil Laut',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(373,123,'3.29.05.1.03','Penatausahaan Izin  Pembinaan  dan Pengawasan Usaha Niaga Bahan Bakar Nabati (Biofuel) sebagai Bahan Bakar Lain dengan Kapasitas Penyediaan sampai dengan 10.000 (sepuluh ribu) Ton Per Tahun',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(374,123,'3.29.05.1.04','Pelaksanaan Konservasi Energi di Wilayah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(375,124,'3.29.06.1.01','Penatausahaan Izin Usaha Penyediaan Tenaga Listrik Non Badan Usaha Milik Negara dan Penjualan Tenaga Listrik serta Penyewaan Jaringan kepada Penyedia Tenaga Listrik dalam Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(376,124,'3.29.06.1.02','Penatausahaan Izin Operasi yang Fasilitas Instalasinya dalam Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(377,124,'3.29.06.1.05','Penatausahaan Izin Usaha Jasa Penunjang Tenaga Listrik bagi Badan Usaha Dalam Negeri/Mayoritas Sahamnya Dimiliki oleh Penanam Modal Dalam Negeri',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(378,124,'3.29.06.1.06','Penganggaran untuk Kelompok Masyarakat Tidak Mampu  Pembangunan Sarana Penyediaan Tenaga Listrik Belum Berkembang  Daerah Terpencil dan Perdesaan',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(379,125,'3.30.01.1.01','Perencanaan  Penganggaran  dan Evaluasi Kinerja Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(380,125,'3.30.01.1.02','Administrasi Keuangan Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(381,125,'3.30.01.1.03','Administrasi Barang Milik Daerah padaPerangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(382,125,'3.30.01.1.05','Administrasi Kepegawaian Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(383,125,'3.30.01.1.06','Administrasi Umum Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(384,125,'3.30.01.1.08','Penyediaan Jasa Penunjang UrusanPemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(385,126,'3.30.03.1.01','Pembangunan dan Pengelolaan Pusat Distribusi Regional dan Pusat Distribusi Provinsi serta Pasar Lelang Komoditas',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(386,127,'3.30.04.1.03','Pengawasan Pupuk dan Pestisida Tingkat Daerah Provinsi dalam Melakukan Pelaksanaan Pengadaan  Penyaluran dan Penggunaan Pupuk Bersubsidi di Wilayah Kerjanya',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(387,129,'3.30.06.1.01','Pelaksanaan Perlindungan Konsumen di Seluruh Daerah Kabupaten/Kota',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(388,129,'3.30.06.1.02','Pelaksanaan Pengujian dan Sertifikasi Mutu Produk di Seluruh Daerah Kabupaten/Kota',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(389,129,'3.30.06.1.03','Pelaksanaan Pengawasan Barang Beredar dan/atau Jasa di Seluruh Daerah Kabupaten/Kota',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(390,130,'3.30.07.1.01','Pelaksanaan Promosi Produk Dalam Negeri',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(391,131,'3.31.02.1.01','Penyusunan  Penerapan  dan Evaluasi Rencana Pembangunan Industri Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(392,132,'3.31.03.1.01','Penerbitan Izin Usaha Industri (IUI)  Izin Perluasan Usaha Industri (IPUI)  Izin Usaha Kawasan Industri (IUKI)  dan Izin Perluasan Kawasan Industri (IPKI) Kewenangan Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(393,133,'3.31.04.1.01','Penyediaan Informasi Industri untuk IUI  IPUI  IUKI  dan IPKI Kewenangan Provinsi Berbasis Sistem Informasi Industri Nasional (SIINas)',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(394,135,'3.32.03.1.01','Penataan Persebaran Penduduk yang Berasal dari Lintas Daerah Kabupaten/Kota dalam 1 (Satu) Daerah Provinsi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(395,136,'3.32.04.1.01','Pengembangan Satuan Permukiman pada Tahap Pemantapan',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(396,137,'4.01.01.1.01','Perencanaan  Penganggaran  dan Evaluasi Kinerja Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(397,137,'4.01.01.1.02','Administrasi Keuangan Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(398,137,'4.01.01.1.03','Administrasi Barang Milik Daerah padaPerangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(399,137,'4.01.01.1.05','Administrasi Kepegawaian Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(400,137,'4.01.01.1.06','Administrasi Umum Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(401,137,'4.01.01.1.07','Pengadaan Barang Milik Daerah PenunjangUrusan Pemerintah Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(402,137,'4.01.01.1.08','Penyediaan Jasa Penunjang UrusanPemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(403,137,'4.01.01.1.09','Pemeliharaan Barang Milik Daerah Penunjang Urusan Pemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(404,137,'4.01.01.1.13','Fasilitasi Materi dan Komunikasi Pimpinan',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(405,137,'4.01.01.1.14','Fasilitasi Keprotokolan',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(406,138,'4.01.02.1.01','Fasilitasi Kelembagaan dan Analisis Jabatan',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(407,138,'4.01.02.1.02','Fasilitasi Reformasi Birokrasi dan Akuntabilitas Kinerja',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(408,139,'4.01.03.1.01','Pelaksanaan Tugas Pemerintahan',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(409,139,'4.01.03.1.02','Pelaksanaan Otonomi Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(410,139,'4.01.03.1.03','Fasilitasi Kerja Sama Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(411,140,'4.01.04.1.01','Fasilitasi Pembinaan Mental Spiritual',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(412,140,'4.01.04.1.02','Fasilitasi Pengembangan Kesejahteraan Rakyat Pelayanan Dasar',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(413,140,'4.01.04.1.03','Fasilitasi Pengembangan Kesejahteraan Rakyat Non Pelayanan Dasar',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(414,141,'4.01.05.1.01','Fasilitasi Penyusunan Perundang-Undangan',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(415,141,'4.01.05.1.02','Fasilitasi Bantuan Hukum',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(416,142,'4.01.06.1.01','Pengelolaan Kebijakan dan Koordinasi Perekonomian',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(417,142,'4.01.06.1.02','Pengelolaan Kebijakan dan Koordinasi Sumber Daya Alam',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(418,142,'4.01.06.1.03','Pengelolaan Kebijakan dan Koordinasi BUMD dan BLUD',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(419,143,'4.01.07.1.01','Pengelolaan Pengadaan Barang dan Jasa',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(420,143,'4.01.07.1.02','Pengelolaan Layanan Pengadaan Secara Elektronik',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(421,143,'4.01.07.1.03','Pembinaan dan Advokasi Pengadaan Barang dan Jasa',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(422,144,'4.01.08.1.01','Pengendalian Administrasi Pelaksanaan Pembangunan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(423,144,'4.01.08.1.02','Pelaporan Pelaksanaan Pembangunan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(424,145,'4.02.01.1.01','Perencanaan  Penganggaran  dan Evaluasi Kinerja Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(425,145,'4.02.01.1.02','Administrasi Keuangan Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(426,145,'4.02.01.1.05','Administrasi Kepegawaian Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(427,145,'4.02.01.1.06','Administrasi Umum Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(428,145,'4.02.01.1.07','Pengadaan Barang Milik Daerah PenunjangUrusan Pemerintah Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(429,145,'4.02.01.1.08','Penyediaan Jasa Penunjang UrusanPemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(430,145,'4.02.01.1.09','Pemeliharaan Barang Milik Daerah Penunjang Urusan Pemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(431,145,'4.02.01.1.15','Layanan Keuangan dan Kesejahteraan DPRD',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(432,145,'4.02.01.1.16','Layanan Administrasi DPRD',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(433,146,'4.02.02.1.01','Pembentukan Perda dan Peraturan DPRD',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(434,146,'4.02.02.1.02','Pembahasan Kebijakan Anggaran',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(435,146,'4.02.02.1.03','Pengawasan Penyelenggaraan Pemerintahan',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(436,146,'4.02.02.1.05','Penyerapan dan Penghimpunan Aspirasi Masyarakat',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(437,146,'4.02.02.1.06','Pelaksanaan dan Pengawasan Kode Etik DPRD',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(438,146,'4.02.02.1.08','Fasilitasi Tugas DPRD',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(439,147,'5.01.01.1.01','Perencanaan  Penganggaran  dan Evaluasi Kinerja Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(440,147,'5.01.01.1.02','Administrasi Keuangan Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(441,147,'5.01.01.1.03','Administrasi Barang Milik Daerah padaPerangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(442,147,'5.01.01.1.05','Administrasi Kepegawaian Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(443,147,'5.01.01.1.06','Administrasi Umum Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(444,147,'5.01.01.1.07','Pengadaan Barang Milik Daerah PenunjangUrusan Pemerintah Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(445,147,'5.01.01.1.08','Penyediaan Jasa Penunjang UrusanPemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(446,147,'5.01.01.1.09','Pemeliharaan Barang Milik Daerah Penunjang Urusan Pemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(447,148,'5.01.02.1.01','Penyusunan Perencanaan dan Pendanaan',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(448,148,'5.01.02.1.02','Analisis Data dan Informasi Pemerintahan Daerah Bidang Perencanaan Pembangunan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(449,148,'5.01.02.1.03','Pengendalian  Evaluasi dan Pelaporan Bidang Perencanaan Pembangunan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(450,148,'5.01.02.1.04','Implementasi Sistem Informasi Pemerintahan Daerah di Bidang Pembangunan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(451,149,'5.01.03.1.01','Koordinasi Perencanaan Bidang Pemerintahan dan Pembangunan Manusia',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(452,149,'5.01.03.1.02','Koordinasi Perencanaan Bidang Perekonomian dan SDA (Sumber Daya Alam)',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(453,149,'5.01.03.1.03','Koordinasi Perencanaan Bidang Infrastruktur dan Kewilayahan',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(454,150,'5.02.01.1.01','Perencanaan  Penganggaran  dan Evaluasi Kinerja Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(455,150,'5.02.01.1.02','Administrasi Keuangan Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(456,150,'5.02.01.1.03','Administrasi Barang Milik Daerah padaPerangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(457,150,'5.02.01.1.04','Administrasi Pendapatan Daerah Kewenangan Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(458,150,'5.02.01.1.05','Administrasi Kepegawaian Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(459,150,'5.02.01.1.07','Pengadaan Barang Milik Daerah PenunjangUrusan Pemerintah Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(460,150,'5.02.01.1.08','Penyediaan Jasa Penunjang UrusanPemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(461,150,'5.02.01.1.09','Pemeliharaan Barang Milik Daerah Penunjang Urusan Pemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(462,151,'5.02.02.1.01','Koordinasi dan Penyusunan Rencana Anggaran Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(463,151,'5.02.02.1.02','Pembinaan Pengelolaan Keuangan Daerah Kabupaten/Kota',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(464,151,'5.02.02.1.03','Koordinasi dan Pengelolaan Perbendaharaan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(465,151,'5.02.02.1.04','Koordinasi dan Pelaksanaan Akuntansi dan Pelaporan Keuangan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(466,151,'5.02.02.1.05','Penunjang Urusan Kewenangan Pengelolaan Keuangan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(467,151,'5.02.02.1.06','Pengelolaan Data dan Implementasi Sistem Informasi Pemerintah Daerah Lingkup Keuangan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(468,152,'5.02.03.1.01','Pengelolaan Barang Milik Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(469,153,'5.02.04.1.01','Kegiatan Pengelolaan Pendapatan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(470,154,'5.03.01.1.01','Perencanaan  Penganggaran  dan Evaluasi Kinerja Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(471,154,'5.03.01.1.02','Administrasi Keuangan Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(472,154,'5.03.01.1.06','Administrasi Umum Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(473,154,'5.03.01.1.08','Penyediaan Jasa Penunjang UrusanPemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(474,155,'5.03.02.1.01','Pengadaan  Pemberhentian dan Informasi Kepegawaian ASN',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(475,155,'5.03.02.1.02','Mutasi dan Promosi ASN',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(476,155,'5.03.02.1.03','Pengembangan Kompetensi ASN',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(477,155,'5.03.02.1.04','Penilaian dan Evaluasi Kinerja Aparatur',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(478,156,'5.04.01.1.01','Perencanaan  Penganggaran  dan Evaluasi Kinerja Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(479,156,'5.04.01.1.02','Administrasi Keuangan Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(480,156,'5.04.01.1.03','Administrasi Barang Milik Daerah padaPerangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(481,156,'5.04.01.1.05','Administrasi Kepegawaian Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(482,156,'5.04.01.1.06','Administrasi Umum Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(483,156,'5.04.01.1.07','Pengadaan Barang Milik Daerah PenunjangUrusan Pemerintah Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(484,156,'5.04.01.1.09','Pemeliharaan Barang Milik Daerah Penunjang Urusan Pemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(485,157,'5.04.02.1.01','Pengembangan Kompetensi Teknis',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(486,157,'5.04.02.1.02','Sertifikasi  Kelembagaan  Pengembangan Kompetensi Manajerial dan Fungsional',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(487,158,'5.05.01.1.01','Perencanaan  Penganggaran  dan Evaluasi Kinerja Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(488,158,'5.05.01.1.02','Administrasi Keuangan Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(489,158,'5.05.01.1.03','Administrasi Barang Milik Daerah padaPerangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(490,158,'5.05.01.1.05','Administrasi Kepegawaian Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(491,158,'5.05.01.1.06','Administrasi Umum Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(492,158,'5.05.01.1.08','Penyediaan Jasa Penunjang UrusanPemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(493,158,'5.05.01.1.09','Pemeliharaan Barang Milik Daerah Penunjang Urusan Pemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(494,159,'5.05.02.1.01','Penelitian dan Pengembangan Bidang Penyelenggaraan Pemerintahan dan Pengkajian Peraturan',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(495,159,'5.05.02.1.02','Penelitian dan Pengembangan Bidang Sosial dan Kependudukan',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(496,159,'5.05.02.1.03','Penelitian dan Pengembangan Bidang Ekonomi dan Pembangunan',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(497,159,'5.05.02.1.04','Pengembangan Inovasi dan Teknologi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(498,160,'5.07.01.1.01','Perencanaan  Penganggaran  dan Evaluasi Kinerja Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(499,160,'5.07.01.1.03','Administrasi Barang Milik Daerah padaPerangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(500,160,'5.07.01.1.05','Administrasi Kepegawaian Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(501,160,'5.07.01.1.06','Administrasi Umum Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(502,160,'5.07.01.1.08','Penyediaan Jasa Penunjang UrusanPemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(503,160,'5.07.01.1.09','Pemeliharaan Barang Milik Daerah Penunjang Urusan Pemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(504,161,'5.07.02.1.01','Pelaksanaan Pelayanan Penghubung',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(505,162,'6.01.01.1.02','Administrasi Keuangan Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(506,162,'6.01.01.1.03','Administrasi Barang Milik Daerah padaPerangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(507,162,'6.01.01.1.05','Administrasi Kepegawaian Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(508,162,'6.01.01.1.06','Administrasi Umum Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(509,162,'6.01.01.1.08','Penyediaan Jasa Penunjang UrusanPemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(510,162,'6.01.01.1.09','Pemeliharaan Barang Milik Daerah Penunjang Urusan Pemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(511,163,'6.01.02.1.01','Penyelenggaraan Pengawasan Internal',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(512,163,'6.01.02.1.02','Penyelenggaraan Pengawasan dengan Tujuan Tertentu',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(513,164,'6.01.03.1.01','Perumusan Kebijakan Teknis di BidangPengawasan dan Fasilitasi Pengawasan',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(514,164,'6.01.03.1.02','Pendampingan dan Asistensi',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(515,165,'8.01.01.1.02','Administrasi Keuangan Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(516,165,'8.01.01.1.03','Administrasi Barang Milik Daerah padaPerangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(517,165,'8.01.01.1.05','Administrasi Kepegawaian Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(518,165,'8.01.01.1.06','Administrasi Umum Perangkat Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(519,165,'8.01.01.1.08','Penyediaan Jasa Penunjang UrusanPemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(520,165,'8.01.01.1.09','Pemeliharaan Barang Milik Daerah Penunjang Urusan Pemerintahan Daerah',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(521,167,'8.01.03.1.01','Perumusan Kebijakan Teknis dan Pemantapan Pelaksanaan Bidang Pendidikan Politik  Etika Budaya Politik  Peningkatan Demokrasi  Fasilitasi Kelembagaan Pemerintahan  Perwakilan dan Partai Politik  Pemilihan Umum/Pemilihan Umum Kepala Daerah  serta Pemantauan Situasi Politik',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(522,168,'8.01.04.1.01','Perumusan Kebijakan Teknis dan Pemantapan Pelaksanaan Bidang Pemberdayaan dan Pengawasan Organisasi Kemasyarakatan',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL),
(523,170,'8.01.06.1.01','Perumusan Kebijakan Teknis dan Pelaksanaan Pemantapan Kewaspadaan Nasional dan Penanganan Konflik Sosial',1,1,'2024-10-15 14:41:34',NULL,NULL,NULL);

/*Table structure for table `master_kegiatan_detail` */

DROP TABLE IF EXISTS `master_kegiatan_detail`;

CREATE TABLE `master_kegiatan_detail` (
  `id_kegiatan_detail` int NOT NULL AUTO_INCREMENT,
  ...
  `updated_by` int DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id_kegiatan_detail`),
  KEY `id_unker` (`id_unker`),
  CONSTRAINT `master_kegiatan_detail_ibfk_1` FOREIGN KEY (`id_unker`) REFERENCES `master_unker` (`ID`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

/*Data for the table `master_kegiatan_detail` */

/*Table structure for table `master_misi_pemda` */

DROP TABLE IF EXISTS `master_misi_pemda`;
...
/*Data for the table `master_misi_pemda` */
...
(1,'Menciptakan Kehidupan yang religius (agamis), berbudaya, aman dan damai.',NULL,NULL,NULL,1,1,'2024-10-08 09:57:19',NULL,NULL),
(2,'Mewujudkan \"good govenance\" untuk meningkatkan kualitas dan pemerataan pelayanan publik.',NULL,NULL,NULL,1,1,'2024-10-08 09:57:19',NULL,NULL),
(3,'Meningkatkan kualitas sumber daya manusia dan mengembangkan upaya perlindungan anak, pemberdayaan perempuan dan penyandang disabilitas.',NULL,NULL,NULL,1,1,'2024-10-08 09:57:19',NULL,NULL),
(4,'Mengembangkan infrastruktur guna meningkatkan efisiensi produksi dan konektivitas wilayah.',NULL,NULL,NULL,1,1,'2024-10-08 09:57:19',NULL,NULL),
(5,'Membangun kekuatan ekonomi masyarakat berbasis pertanian dan wilayah perdesaan yang seimbang dengan wilayah perkotaan.',NULL,NULL,NULL,1,1,'2024-10-08 09:57:19',NULL,NULL),
(6,'Mewujudkan pembangunan daerah berkelanjutan untuk kesejahteraan bersama.',NULL,NULL,NULL,1,1,'2024-10-08 09:57:19',NULL,NULL);
...
CREATE TABLE `master_program` (
  ...
  UNIQUE KEY `kode_rekening` (`kode_rekening`),
  KEY `id_sub_urusan` (`id_sub_urusan`),
  KEY `fk_program_unker` (`id_unker`),
  CONSTRAINT `fk_program_unker` FOREIGN KEY (`id_unker`) REFERENCES `master_unker` (`ID`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=256 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

/*Data for the table `master_program` */
...
(1,1,'1.01.01','PROGRAM PENUNJANG URUSAN PEMERINTAHAN DAERAH PROVINSI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(2,1,'1.01.02','PROGRAM PENGELOLAAN PENDIDIKAN',1,NULL,NULL,NULL,NULL,NULL),
(3,1,'1.01.04','PROGRAM PENDIDIK DAN TENAGA KEPENDIDIKAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(4,2,'1.02.01','PROGRAM PENUNJANG URUSAN PEMERINTAHAN DAERAH PROVINSI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(5,2,'1.02.02','PROGRAM PEMENUHAN UPAYA KESEHATAN PERORANGAN DAN UPAYA KESEHATAN MASYARAKAT ',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(6,2,'1.02.03','PROGRAM PENINGKATAN KAPASITAS SUMBER DAYA MANUSIA KESEHATAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(7,2,'1.02.04','PROGRAM SEDIAAN FARMASI, ALAT KESEHATAN DAN MAKANAN MINUMAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(8,2,'1.02.05','PROGRAM PEMBERDAYAAN MASYARAKAT BIDANG KESEHATAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(9,3,'1.03.01','PROGRAM PENUNJANG URUSAN PEMERINTAHAN DAERAH PROVINSI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(10,3,'1.03.02','PROGRAM PENGELOLAAN SUMBER DAYA AIR (SDA)',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(11,3,'1.03.03','PROGRAM PENGELOLAAN DAN PENGEMBANGAN SISTEM PENYEDIAAN AIR MINUM',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(12,3,'1.03.04','PROGRAM PENGEMBANGAN SISTEM DAN PENGELOLAAN PERSAMPAHAN REGIONAL',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(13,3,'1.03.05','PROGRAM PENGELOLAAN DAN PENGEMBANGAN SISTEM AIR LIMBAH',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(14,3,'1.03.07','PROGRAM PENGEMBANGAN PERMUKIMAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(15,3,'1.03.08','PROGRAM PENATAAN BANGUNAN GEDUNG',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(16,3,'1.03.09','PROGRAM PENATAAN BANGUNAN DAN LINGKUNGANNYA',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(17,3,'1.03.10','PROGRAM PENYELENGGARAAN JALAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(18,3,'1.03.11','PROGRAM PENGEMBANGAN JASA KONSTRUKSI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(19,3,'1.03.12','PROGRAM PENYELENGGARAAN PENATAAN RUANG',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(20,4,'1.04.01','PROGRAM PENUNJANG URUSAN PEMERINTAHAN DAERAH PROVINSI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(21,4,'1.04.03','PROGRAM KAWASAN PERMUKIMAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(22,4,'1.04.05','PROGRAM PENINGKATAN PRASARANA, SARANA DAN UTILITAS UMUM (PSU)',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(23,5,'1.05.01','PROGRAM PENUNJANG URUSAN PEMERINTAHAN DAERAH PROVINSI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(24,6,'1.06.01','PROGRAM PENUNJANG URUSAN PEMERINTAHAN DAERAH PROVINSI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(25,6,'1.06.03','PROGRAM PENANGANAN WARGA NEGARA MIGRAN KORBAN TINDAK KEKERASAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(26,6,'1.06.04','PROGRAM REHABILITASI SOSIAL',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(27,6,'1.06.05','PROGRAM PERLINDUNGAN DAN JAMINAN SOSIAL',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(28,6,'1.06.06','PROGRAM PENANGANAN BENCANA',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(29,6,'1.06.07','PROGRAM PENGELOLAAN TAMAN MAKAM PAHLAWAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(30,7,'2.07.01','PROGRAM PENUNJANG URUSAN PEMERINTAHAN DAERAH PROVINSI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(31,7,'2.07.02','PROGRAM PERENCANAAN TENAGA KERJA',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(32,7,'2.07.03','PROGRAM PELATIHAN KERJA DAN PRODUKTIVITAS TENAGA KERJA',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(33,7,'2.07.04','PROGRAM PENEMPATAN TENAGA KERJA',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(34,7,'2.07.05','PROGRAM HUBUNGAN INDUSTRIAL',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(35,7,'2.07.06','PROGRAM PENGAWASAN KETENAGAKERJAAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(36,8,'2.08.01','PROGRAM PENUNJANG URUSAN PEMERINTAHAN DAERAH PROVINSI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(37,8,'2.08.02','PROGRAM PENGARUSUTAMAAN GENDER DAN PEMBERDAYAAN PEREMPUAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(38,8,'2.08.03','PROGRAM PERLINDUNGAN PEREMPUAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(39,8,'2.08.04','PROGRAM PENINGKATAN KUALITAS KELUARGA',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(40,8,'2.08.05','PROGRAM PENGELOLAAN SISTEM DATA GENDER DAN ANAK',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(41,8,'2.08.06','PROGRAM PEMENUHAN HAK ANAK (PHA)',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(42,8,'2.08.07','PROGRAM PERLINDUNGAN KHUSUS ANAK',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(43,9,'2.09.03','PROGRAM PENINGKATAN DIVERSIFIKASI DAN KETAHANAN PANGAN MASYARAKAT',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(44,10,'2.10.10','PROGRAM PENATAGUNAAN TANAH ',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(45,11,'2.11.01','PROGRAM PENUNJANG URUSAN PEMERINTAHAN DAERAH PROVINSI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(46,11,'2.11.02','PROGRAM Perencanaan LINGKUNGAN HIDUP',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(47,11,'2.11.03','PROGRAM PENGENDALIAN PENCEMARAN DAN/ATAU KERUSAKAN LINGKUNGAN HIDUP',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(48,11,'2.11.04','PROGRAM PENGELOLAAN KEANEKARAGAMAN HAYATI (KEHATI)',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(49,11,'2.11.05','PROGRAM PENGENDALIAN BAHAN BERBAHAYA DAN BERACUN (B3) DAN LIMBAH BAHAN BERBAHAYA DAN BERACUN (LIMBAH B3)',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(50,11,'2.11.06','PROGRAM PEMBINAAN DAN PENGAWASAN TERHADAP IZIN LINGKUNGAN DAN IZIN PERLINDUNGAN DAN PENGELOLAAN LINGKUNGAN HIDUP (PPLH)',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(51,11,'2.11.08','PROGRAM PENINGKATAN PENDIDIKAN, PELATIHAN DAN PENYULUHAN LINGKUNGAN HIDUP UNTUK MASYARAKAT',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(52,11,'2.11.09','PROGRAM PENGHARGAAN LINGKUNGAN HIDUP UNTUK MASYARAKAT',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(53,11,'2.11.10','PROGRAM PENANGANAN PENGADUAN LINGKUNGAN HIDUP',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(54,11,'2.11.11','PROGRAM PENGELOLAAN PERSAMPAHAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(55,12,'2.12.01','PROGRAM PENUNJANG URUSAN PEMERINTAHAN DAERAH PROVINSI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(56,12,'2.12.02','PROGRAM PENDAFTARAN PENDUDUK',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(57,12,'2.12.03','PROGRAM PENCATATAN SIPIL',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(58,12,'2.12.04','PROGRAM PENGELOLAAN INFORMASI ADMINISTRASI KEPENDUDUKAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(59,12,'2.12.05','PROGRAM PENGELOLAAN PROFIL KEPENDUDUKAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(60,13,'2.13.01','PROGRAM PENUNJANG URUSAN PEMERINTAHAN DAERAH PROVINSI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(61,13,'2.13.03','PROGRAM PENINGKATAN KERJA SAMA DESA',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(62,14,'2.14.02','PROGRAM PENGENDALIAN PENDUDUK',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(63,14,'2.14.03','PROGRAM PEMBINAAN KELUARGA BERENCANA (KB)',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(64,14,'2.14.04','PROGRAM PEMBERDAYAAN DAN PENINGKATAN KELUARGA SEJAHTERA (KS)',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(65,15,'2.15.01','PROGRAM PENUNJANG URUSAN PEMERINTAHAN DAERAH PROVINSI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(66,15,'2.15.02','PROGRAM PENYELENGGARAAN LALU LINTAS DAN ANGKUTAN JALAN (LLAJ)',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(67,15,'2.15.03','PROGRAM PENGELOLAAN PELAYARAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(68,15,'2.15.05','PROGRAM PENGELOLAAN PERKERETAAPIAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(69,16,'2.16.01','PROGRAM PENUNJANG URUSAN PEMERINTAHAN DAERAH PROVINSI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(70,16,'2.16.02','PROGRAM PENGELOLAAN INFORMASI DAN KOMUNIKASI PUBLIK',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(71,16,'2.16.03','PROGRAM PENGELOLAAN APLIKASI INFORMATIKA',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(72,16,'2.17.01','PROGRAM PENUNJANG URUSAN PEMERINTAHAN DAERAH PROVINSI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(73,16,'2.17.02','PROGRAM PELAYANAN IZIN USAHA SIMPAN PINJAM',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(74,16,'2.17.03','PROGRAM PENGAWASAN DAN PEMERIKSAAN KOPERASI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(75,16,'2.17.04','PROGRAM PENILAIAN KESEHATAN KSP/USP KOPERASI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(76,16,'2.17.06','PROGRAM PEMBERDAYAAN DAN PERLINDUNGAN KOPERASI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(77,16,'2.17.08','PROGRAM PENGEMBANGAN UMKM',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(78,17,'2.18.01','PROGRAM PENUNJANG URUSAN PEMERINTAHAN DAERAH PROVINSI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(79,17,'2.18.02','PROGRAM PENGEMBANGAN IKLIM PENANAMAN MODAL',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(80,17,'2.18.04','PROGRAM PELAYANAN PENANAMAN MODAL',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(81,17,'2.18.05','PROGRAM PENGENDALIAN PELAKSANAAN PENANAMAN MODAL',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(82,18,'2.19.01','PROGRAM PENUNJANG URUSAN PEMERINTAHAN DAERAH PROVINSI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(83,18,'2.19.02','PROGRAM PENGEMBANGAN KAPASITAS DAYA SAING KEPEMUDAAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(84,18,'2.19.03','PROGRAM PENGEMBANGAN DAYA SAING KEOLAHRAGAAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(85,18,'2.19.04','PROGRAM PENGEMBANGAN KAPASITAS KEPRAMUKAAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(86,19,'2.20.02','PROGRAM PENYELENGGARAAN STATISTIK SEKTORAL',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(87,20,'2.21.02','PROGRAM PENYELENGGARAAN PERSANDIAN UNTUK PENGAMANAN INFORMASI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(88,21,'2.22.02','PROGRAM PENGEMBANGAN KEBUDAYAAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(89,21,'2.22.03','PROGRAM PENGEMBANGAN KESENIAN TRADISIONAL',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(90,21,'2.22.04','PROGRAM PEMBINAAN SEJARAH',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(91,21,'2.22.05','PROGRAM PELESTARIAN DAN PENGELOLAAN CAGAR BUDAYA',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(92,21,'2.22.06','PROGRAM PENGELOLAAN PERMUSEUMAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(93,22,'2.23.01','PROGRAM PENUNJANG URUSAN PEMERINTAHAN DAERAH PROVINSI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(94,22,'2.23.02','PROGRAM PEMBINAAN PERPUSTAKAAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(95,22,'2.23.03','PROGRAM PELESTARIAN KOLEKSI NASIONAL DAN NASKAH KUNO',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(96,23,'2.24.02','PROGRAM PENGELOLAAN ARSIP',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(97,24,'3.25.01','PROGRAM PENUNJANG URUSAN PEMERINTAHAN DAERAH PROVINSI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(98,24,'3.25.02','PROGRAM PENGELOLAAN KELAUTAN, PESISIR DAN PULAU-PULAU KECIL',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(99,24,'3.25.03','PROGRAM PENGELOLAAN PERIKANAN TANGKAP',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(100,24,'3.25.04','PROGRAM PENGELOLAAN PERIKANAN BUDIDAYA',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(101,24,'3.25.05','PROGRAM PENGAWASAN SUMBER DAYA KELAUTAN DAN PERIKANAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(102,24,'3.25.06','PROGRAM PENGOLAHAN DAN PEMASARAN HASIL PERIKANAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(103,25,'3.26.01','PROGRAM PENUNJANG URUSAN PEMERINTAHAN DAERAH PROVINSI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(104,25,'3.26.02','PROGRAM PENINGKATAN DAYA TARIK DESTINASI PARIWISATA',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(105,25,'3.26.03','PROGRAM PEMASARAN PARIWISATA',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(106,25,'3.26.04','PROGRAM PENGEMBANGAN EKONOMI KREATIF MELALUI PEMANFAATAN DAN PERLINDUNGAN HAK KEKAYAAN INTELEKTUAL',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(107,25,'3.26.05','PROGRAM PENGEMBANGAN SUMBER DAYA PARIWISATA DAN EKONOMI KREATIF',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(108,25,'3.27.01','PROGRAM PENUNJANG URUSAN PEMERINTAHAN DAERAH PROVINSI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(109,25,'3.27.02','PROGRAM PENYEDIAAN DAN PENGEMBANGAN SARANA PERTANIAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(110,25,'3.27.03','PROGRAM PENYEDIAAN DAN PENGEMBANGAN PRASARANA PERTANIAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(111,25,'3.27.04','PROGRAM PENGENDALIAN KESEHATAN HEWAN DAN KESEHATAN MASYARAKAT VETERINER',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(112,25,'3.27.05','PROGRAM PENGENDALIAN DAN PENANGGULANGAN BENCANA PERTANIAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(113,25,'3.27.06','PROGRAM PERIZINAN USAHA PERTANIAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(114,25,'3.27.07','PROGRAM PENYULUHAN PERTANIAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(115,26,'3.28.01','PROGRAM PENUNJANG URUSAN PEMERINTAHAN DAERAH PROVINSI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(116,26,'3.28.03','PROGRAM PENGELOLAAN HUTAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(117,26,'3.28.04','PROGRAM KONSERVASI SUMBER DAYA ALAM HAYATI DAN EKOSISTEMNYA',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(118,26,'3.28.05','PROGRAM PENDIDIKAN DAN PELATIHAN, PENYULUHAN DAN PEMBERDAYAAN MASYARAKAT DI BIDANG KEHUTANAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(119,26,'3.28.06','PROGRAM PENGELOLAAN DAERAH ALIRAN SUNGAI (DAS)',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(120,27,'3.29.01','PROGRAM PENUNJANG URUSAN PEMERINTAHAN DAERAH PROVINSI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(121,27,'3.29.02','PROGRAM PENGELOLAAN ASPEK KEGEOLOGIAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(122,27,'3.29.03','PROGRAM PENGELOLAAN MINERAL DAN BATUBARA',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(123,27,'3.29.05','PROGRAM PENGELOLAAN ENERGI BARU TERBARUKAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(124,27,'3.29.06','PROGRAM PENGELOLAAN KETENAGALISTRIKAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(125,28,'3.30.01','PROGRAM PENUNJANG URUSAN PEMERINTAHAN DAERAH PROVINSI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(126,28,'3.30.03','PROGRAM PENINGKATAN SARANA DISTRIBUSI PERDAGANGAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(127,28,'3.30.04','PROGRAM STABILISASI HARGA BARANG Kebutuhan POKOK DAN BARANG PENTING',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(128,28,'3.30.05','PROGRAM PENGEMBANGAN EKSPOR',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(129,28,'3.30.06','PROGRAM STANDARDISASI DAN PERLINDUNGAN KONSUMEN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(130,28,'3.30.07','PROGRAM PENGGUNAAN DAN PEMASARAN PRODUK DALAM NEGERI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(131,29,'3.31.02','PROGRAM Perencanaan DAN PEMBANGUNAN INDUSTRI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(132,29,'3.31.03','PROGRAM PENGENDALIAN IZIN USAHA INDUSTRI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(133,29,'3.31.04','PROGRAM PENGELOLAAN SISTEM INFORMASI INDUSTRI NASIONAL',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(134,30,'3.32.02','PROGRAM Perencanaan KAWASAN TRANSMIGRASI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(135,30,'3.32.03','PROGRAM PEMBANGUNAN KAWASAN TRANSMIGRASI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(136,30,'3.32.04','PROGRAM PENGEMBANGAN KAWASAN TRANSMIGRASI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(137,31,'4.01.01','PROGRAM PENUNJANG URUSAN PEMERINTAHAN DAERAH PROVINSI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(138,31,'4.01.02','PROGRAM PENATAAN ORGANISASI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(139,31,'4.01.03','PROGRAM PEMERINTAHAN DAN OTONOMI DAERAH',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(140,31,'4.01.04','PROGRAM KESEJAHTERAAN RAKYAT',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(141,31,'4.01.05','PROGRAM FASILITASI DAN KOORDINASI HUKUM',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(142,31,'4.01.06','PROGRAM PEREKONOMIAN DAN PEMBANGUNAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(143,31,'4.01.07','PROGRAM KEBIJAKAN DAN PELAYANAN PENGADAAN BARANG DAN JASA',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(144,31,'4.01.08','PROGRAM KEBIJAKAN ADMINISTRASI PEMBANGUNAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(145,32,'4.02.01','PROGRAM PENUNJANG URUSAN PEMERINTAHAN DAERAH PROVINSI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(146,32,'4.02.02','PROGRAM DUKUNGAN PELAKSANAAN TUGAS DAN FUNGSI DPRD',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(147,33,'5.01.01','PROGRAM PENUNJANG URUSAN PEMERINTAHAN DAERAH PROVINSI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(148,33,'5.01.02','PROGRAM PERENCANAAN PENGENDALIAN, DAN EVALUASI PEMBANGUNAN DAERAH',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(149,33,'5.01.03','PROGRAM KOORDINASI DAN SINKRONISASI PERENCANAAN PEMBANGUNAN DAERAH',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(150,34,'5.02.01','PROGRAM PENUNJANG URUSAN PEMERINTAHAN DAERAH PROVINSI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(151,34,'5.02.02','PROGRAM PENGELOLAAN KEUANGAN DAERAH',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(152,34,'5.02.03','PROGRAM PENGELOLAAN BARANG MILIK DAERAH',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(153,34,'5.02.04','PROGRAM PENGELOLAAN PENDAPATAN DAERAH',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(154,35,'5.03.01','PROGRAM PENUNJANG URUSAN PEMERINTAHAN DAERAH PROVINSI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(155,35,'5.03.02','PROGRAM KEPEGAWAIAN DAERAH',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(156,36,'5.04.01','PROGRAM PENUNJANG URUSAN PEMERINTAHAN DAERAH PROVINSI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(157,36,'5.04.02','PROGRAM PENGEMBANGAN SUMBER DAYA MANUSIA',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(158,37,'5.05.01','PROGRAM PENUNJANG URUSAN PEMERINTAHAN DAERAH PROVINSI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(159,37,'5.05.02','PROGRAM PENELITIAN DAN PENGEMBANGAN DAERAH',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(160,38,'5.07.01','PROGRAM PENUNJANG URUSAN PEMERINTAHAN DAERAH PROVINSI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(161,38,'5.07.02','PROGRAM PELAYANAN PENGHUBUNG',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(162,39,'6.01.01','PROGRAM PENUNJANG URUSAN PEMERINTAHAN DAERAH PROVINSI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(163,39,'6.01.02','PROGRAM PENYELENGGARAAN PENGAWASAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(164,39,'6.01.03','PROGRAM PERUMUSAN KEBIJAKAN, PENDAMPINGAN DAN ASISTENSI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(165,40,'8.01.01','PROGRAM PENUNJANG URUSAN PEMERINTAHAN DAERAH PROVINSI',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(166,40,'8.01.02','PROGRAM PENGUATAN IDEOLOGI PANCASILA DAN KARAKTER KEBANGSAAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(167,40,'8.01.03','PROGRAM PENINGKATAN PERAN PARTAI POLITIK DAN LEMBAGA PENDIDIKAN MELALUI PENDIDIKAN POLITIK DAN PENGEMBANGAN ETIKA SERTA BUDAYA POLITIK',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(168,40,'8.01.04','PROGRAM PEMBERDAYAAN DAN PENGAWASAN ORGANISASI KEMASYARAKATAN',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(169,40,'8.01.05','PROGRAM PEMBINAAN DAN PENGEMBANGAN KETAHANAN EKONOMI, SOSIAL, DAN BUDAYA',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL),
(170,40,'8.01.06','PROGRAM PENINGKATAN KEWASPADAAN NASIONAL DAN PENINGKATAN KUALITAS DAN FASILITASI PENANGANAN KONFLIK SOSIAL',1,1,'2024-10-15 11:54:54',NULL,NULL,NULL);

/*Table structure for table `master_program_detail` */

DROP TABLE IF EXISTS `master_program_detail`;

CREATE TABLE `master_program_detail` (
  `id_program_detail` int NOT NULL AUTO_INCREMENT,
  `id_program` int DEFAULT NULL,
  `id_unker` int DEFAULT NULL,
  `created_by` int DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  ...
  KEY `id_unker` (`id_unker`),
  CONSTRAINT `master_program_detail_ibfk_1` FOREIGN KEY (`id_unker`) REFERENCES `master_unker` (`ID`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

/*Data for the table `master_program_detail` */
...
CREATE TABLE `master_sub_kegiatan` (
  ...
  KEY `fk_sub_kegiatan_unker` (`id_unker`),
  CONSTRAINT `fk_sub_kegiatan_unker` FOREIGN KEY (`id_unker`) REFERENCES `master_unker` (`ID`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=1674 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

/*Data for the table `master_sub_kegiatan` */
...
DROP TABLE IF EXISTS `master_sub_kegiatan_detail`;

CREATE TABLE `master_sub_kegiatan_detail` (
  `id_sub_kegiatan_detail` int NOT NULL AUTO_INCREMENT,
  ...
  `updated_by` int DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id_sub_kegiatan_detail`),
  KEY `id_unker` (`id_unker`),
  CONSTRAINT `master_sub_kegiatan_detail_ibfk_1` FOREIGN KEY (`id_unker`) REFERENCES `master_unker` (`ID`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

/*Data for the table `master_sub_kegiatan_detail` */

/*Table structure for table `master_sub_urusan` */

DROP TABLE IF EXISTS `master_sub_urusan`;

CREATE TABLE `master_sub_urusan` (
  `id_sub_urusan` int NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  `id_unker` int DEFAULT NULL,
  PRIMARY KEY (`id_sub_urusan`),
  UNIQUE KEY `kode_rekening` (`kode_rekening`),
  KEY `id_urusan` (`id_urusan`),
  KEY `fk_sub_urusan_unker` (`id_unker`),
  CONSTRAINT `fk_sub_urusan_unker` FOREIGN KEY (`id_unker`) REFERENCES `master_unker` (`ID`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `master_sub_urusan_ibfk_1` FOREIGN KEY (`id_urusan`) REFERENCES `master_urusan` (`id_urusan`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

/*Data for the table `master_sub_urusan` */
...
(1,1,'1.01','URUSAN PEMERINTAHAN BIDANG PENDIDIKAN',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(2,1,'1.02','URUSAN PEMERINTAHAN BIDANG KESEHATAN',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(3,1,'1.03','URUSAN PEMERINTAHAN BIDANG PEKERJAAN UMUM DAN PENATAAN RUANG',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(4,1,'1.04','URUSAN PEMERINTAHAN BIDANG PERUMAHAN DAN KAWASAN PERMUKIMAN',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(5,1,'1.05','URUSAN PEMERINTAHAN BIDANG KETENTERAMAN DAN KETERTIBAN UMUM SERTA PERLINDUNGAN MASYARAKAT',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(6,1,'1.06','URUSAN PEMERINTAHAN BIDANG SOSIAL',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(7,2,'2.07','URUSAN PEMERINTAHAN BIDANG TENAGA KERJA',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(8,2,'2.08','URUSAN PEMERINTAHAN BIDANG PEMBERDAYAAN PEREMPUAN DAN PERLINDUNGAN ANAK',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(9,2,'2.09','URUSAN PEMERINTAHAN BIDANG PANGAN',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(10,2,'2.10','URUSAN PEMERINTAHAN BIDANG PERTANAHAN',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(11,2,'2.11','URUSAN PEMERINTAHAN BIDANG LINGKUNGAN HIDUP',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(12,2,'2.12','URUSAN PEMERINTAHAN BIDANG ADMINISTRASI KEPENDUDUKAN DAN PENCATATAN SIPIL',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(13,2,'2.13','URUSAN PEMERINTAHAN BIDANG PEMBERDAYAAN MASYARAKAT DAN DESA',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(14,2,'2.14','URUSAN PEMERINTAHAN BIDANG PENGENDALIAN PENDUDUK DAN KELUARGA BERENCANA',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(15,2,'2.15','URUSAN PEMERINTAHAN BIDANG PERHUBUNGAN',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(16,2,'2.16','URUSAN PEMERINTAHAN BIDANG KOMUNIKASI DAN INFORMATIKA',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(17,2,'2.18','URUSAN PEMERINTAHAN BIDANG PENANAMAN MODAL',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(18,2,'2.19','URUSAN PEMERINTAHAN BIDANG KEPEMUDAAN DAN OLAHRAGA',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(19,2,'2.20','URUSAN PEMERINTAHAN BIDANG STATISTIK',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(20,2,'2.21','URUSAN PEMERINTAHAN BIDANG PERSANDIAN',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(21,2,'2.22','URUSAN PEMERINTAHAN BIDANG KEBUDAYAAN',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(22,2,'2.23','URUSAN PEMERINTAHAN BIDANG PERPUSTAKAAN',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(23,2,'2.24','URUSAN PEMERINTAHAN BIDANG KEARSIPAN',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(24,3,'3.25','URUSAN PEMERINTAHAN BIDANG KELAUTAN DAN PERIKANAN',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(25,3,'3.26','URUSAN PEMERINTAHAN BIDANG PARIWISATA',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(26,3,'3.28','URUSAN PEMERINTAHAN BIDANG KEHUTANAN',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(27,3,'3.29','URUSAN PEMERINTAHAN BIDANG ENERGI DAN SUMBER DAYA MINERAL',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(28,3,'3.30','URUSAN PEMERINTAHAN BIDANG PERDAGANGAN',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(29,3,'3.31','URUSAN PEMERINTAHAN BIDANG PERINDUSTRIAN',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(30,3,'3.32','URUSAN PEMERINTAHAN BIDANG TRANSMIGRASI',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(31,4,'4.01','SEKRETARIAT DAERAH',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(32,4,'4.02','SEKRETARIAT DPRD',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(33,5,'5.01','PERENCANAAN',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(34,5,'5.02','KEUANGAN',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(35,5,'5.03','KEPEGAWAIAN',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(36,5,'5.04','PENDIDIKAN DAN PELATIHAN',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(37,5,'5.05','PENELITIAN DAN PENGEMBANGAN',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(38,5,'5.07','PENGELOLAAN PENGHUBUNG',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(39,6,'6.01','INSPEKTORAT DAERAH',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL),
(40,8,'8.01','KESATUAN BANGSA DAN POLITIK',1,1,'2024-10-15 10:56:06',NULL,NULL,NULL);

/*Table structure for table `master_unker` */

DROP TABLE IF EXISTS `master_unker`;
...
/*Data for the table `master_unker` */
...
CREATE TABLE `master_urusan` (
  ...
  UNIQUE KEY `kode_rekening` (`kode_rekening`),
  KEY `fk_urusan_unker` (`id_unker`),
  CONSTRAINT `fk_urusan_unker` FOREIGN KEY (`id_unker`) REFERENCES `master_unker` (`ID`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

/*Data for the table `master_urusan` */
...
CREATE TABLE `messages` (
  ...
  CONSTRAINT `messages_ibfk_1` FOREIGN KEY (`id_ticket`) REFERENCES `tickets` (`id_ticket`) ON DELETE CASCADE ON UPDATE CASCADE,
...
(2,'Logo Aplikasi','app_logo','settings/v7PDtYHqNTvUbRx0sq0Kkf0UdfWxDXC3ba3Y5nCZ.png','Silahkan upload logo aplikasi anda dengan benar.','file','2022-08-11 15:18:22','2024-10-08 10:51:35'),
...
(5,'Favicon Aplikasi','app_favicon','settings/UbLkcNMlQ5jCEtNjQZpy09ba3ZCCfVOb7R5F5l07.ico','Silahkan isi favicon aplikasi anda dengan benar.','file','2022-08-11 15:18:22','2024-10-08 10:51:35'),
(6,'Deskripsi Aplikasi','app_description','Sistem Informasi Monitoring dan Evaluasi Pemerintahan Daerah Provinsi Lampung','Silahkan isi deskripsi aplikasi anda dengan benar.','text','2022-08-11 15:18:22','2024-10-08 13:03:42'),
...
(11,'Background Login','app_bg_login','settings/2pU8nYglNCMY2hPAFkwcEdlvZblAikPJaxQXq2NS.jpg','Silahkan pilih background untuk login','file','2022-08-11 15:18:22','2024-10-08 10:51:35'),
...
CREATE TABLE `ticket_assignments` (
  ...
  UNIQUE KEY `id_assignment` (`id_assignment`),
  KEY `id_ticket` (`id_ticket`),
  KEY `agent_id` (`agent_id`),
  CONSTRAINT `ticket_assignments_ibfk_1` FOREIGN KEY (`id_ticket`) REFERENCES `tickets` (`id_ticket`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `ticket_assignments_ibfk_2` FOREIGN KEY (`agent_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

/*Data for the table `ticket_assignments` */
...
DROP TABLE IF EXISTS `tr_iku`;

CREATE TABLE `tr_iku` (
  `id_iku` int NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id_iku`),
  KEY `id_misi` (`id_misi`),
  CONSTRAINT `tr_iku_ibfk_1` FOREIGN KEY (`id_misi`) REFERENCES `master_misi_pemda` (`id_misi`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

/*Data for the table `tr_iku` */

/*Table structure for table `tr_iku_detail` */

DROP TABLE IF EXISTS `tr_iku_detail`;
...
CREATE TABLE `tr_iku_detail` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `id_iku_target_realisasi` (`id_iku_target_realisasi`),
  CONSTRAINT `tr_iku_detail_ibfk_1` FOREIGN KEY (`id_iku_target_realisasi`) REFERENCES `tr_iku_target_realisasi` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

/*Data for the table `tr_iku_detail` */

/*Table structure for table `tr_iku_opd` */

DROP TABLE IF EXISTS `tr_iku_opd`;

CREATE TABLE `tr_iku_opd` (
  `id_iku_opd` int NOT NULL AUTO_INCREMENT,
  ...
  `updated_by` int DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id_iku_opd`),
  KEY `id_iku_rpjmd` (`id_iku_rpjmd`),
  KEY `id_perangkat_daerah` (`id_perangkat_daerah`),
  KEY `id_kegiatan` (`id_kegiatan`),
  KEY `id_sub_kegiatan` (`id_sub_kegiatan`),
  KEY `tr_iku_opd_ibfk_3` (`id_program`),
  CONSTRAINT `tr_iku_opd_ibfk_1` FOREIGN KEY (`id_iku_rpjmd`) REFERENCES `tr_iku_rpjmd` (`id_iku_rpjmd`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `tr_iku_opd_ibfk_2` FOREIGN KEY (`id_perangkat_daerah`) REFERENCES `master_unker` (`ID`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `tr_iku_opd_ibfk_3` FOREIGN KEY (`id_program`) REFERENCES `master_program` (`id_program`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `tr_iku_opd_ibfk_4` FOREIGN KEY (`id_kegiatan`) REFERENCES `master_kegiatan` (`id_kegiatan`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `tr_iku_opd_ibfk_5` FOREIGN KEY (`id_sub_kegiatan`) REFERENCES `master_sub_kegiatan` (`id_sub_kegiatan`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

/*Data for the table `tr_iku_opd` */

/*Table structure for table `tr_iku_rpjmd` */

DROP TABLE IF EXISTS `tr_iku_rpjmd`;

CREATE TABLE `tr_iku_rpjmd` (
  `id_iku_rpjmd` int NOT NULL AUTO_INCREMENT,
  `id_misi` int DEFAULT NULL,
  ...
  `updated_by` int DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id_iku_rpjmd`),
  KEY `id_misi` (`id_misi`),
  CONSTRAINT `tr_iku_rpjmd_ibfk_1` FOREIGN KEY (`id_misi`) REFERENCES `master_misi_pemda` (`id_misi`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

/*Data for the table `tr_iku_rpjmd` */

/*Table structure for table `tr_iku_target_realisasi` */

DROP TABLE IF EXISTS `tr_iku_target_realisasi`;
...
CREATE TABLE `tr_iku_target_realisasi` (
  ...
  PRIMARY KEY (`id`),
  KEY `id_iku` (`id_iku`),
  CONSTRAINT `tr_iku_target_realisasi_ibfk_1` FOREIGN KEY (`id_iku`) REFERENCES `tr_iku` (`id_iku`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

/*Data for the table `tr_iku_target_realisasi` */

/*Table structure for table `tr_indikator` */

DROP TABLE IF EXISTS `tr_indikator`;
...
CREATE TABLE `tr_indikator` (
  ...
  KEY `id_kegiatan` (`id_kegiatan`),
  KEY `id_sub_kegiatan` (`id_sub_kegiatan`),
  KEY `fk_indikator_unker` (`id_unker`),
  CONSTRAINT `fk_indikator_unker` FOREIGN KEY (`id_unker`) REFERENCES `master_unker` (`ID`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `tr_indikator_ibfk_1` FOREIGN KEY (`id_program`) REFERENCES `master_program` (`id_program`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `tr_indikator_ibfk_2` FOREIGN KEY (`id_kegiatan`) REFERENCES `master_kegiatan` (`id_kegiatan`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `tr_indikator_ibfk_3` FOREIGN KEY (`id_sub_kegiatan`) REFERENCES `master_sub_kegiatan` (`id_sub_kegiatan`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

/*Data for the table `tr_indikator` */

/*Table structure for table `transaksi_rencana_kerja` */

DROP TABLE IF EXISTS `tr_rencana_kerja`;

CREATE TABLE `tr_rencana_kerja` (
  `id` int NOT NULL AUTO_INCREMENT,
  `indikator_id` int DEFAULT NULL,
  `target_akhir_periode` float DEFAULT NULL,
  `realisasi_capaian` float DEFAULT NULL,
  `prakiraan_capaian` float DEFAULT NULL,
  `target_tahun` year DEFAULT NULL,
  `pagu_indikatif` decimal(20,2) DEFAULT NULL,
  `prioritas` enum('Nasional','Daerah') DEFAULT NULL,
  `label_prioritas` varchar(2000) DEFAULT NULL,
  `lokasi` varchar(2000) DEFAULT NULL,
  `sumber_dana_id` int DEFAULT NULL,
  `kelompok_sasaran` varchar(2000) DEFAULT NULL,
  `target_prakiraan` float DEFAULT NULL,
  `pagu_prakiraan` decimal(20,2) DEFAULT NULL,
  `unit_kerja_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `indikator_id` (`indikator_id`),
  KEY `sumber_dana_id` (`sumber_dana_id`),
  KEY `unit_kerja_id` (`unit_kerja_id`),
  CONSTRAINT `transaksi_rencana_kerja_ibfk_1` FOREIGN KEY (`indikator_id`) REFERENCES `tr_indikator` (`id_indikator`),
  CONSTRAINT `transaksi_rencana_kerja_ibfk_2` FOREIGN KEY (`sumber_dana_id`) REFERENCES `sumber_dana` (`id`),
  CONSTRAINT `transaksi_rencana_kerja_ibfk_3` FOREIGN KEY (`unit_kerja_id`) REFERENCES `master_unker` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

/*Data for the table `transaksi_rencana_kerja` */
...
(1,'superadmin','Avril Lavigne','avril@gmail.com',NULL,'$2y$10$wG8pqlTJ5/qJGNCm8Ahx/.qs6xV29NPCfl0NUcu/.3CaAFS7frtEO','users/355E1lzftbUPLgzn6yjEJMPyVYpYwejxoSCKDdfT.jpg',1,'Jo2jCcB1dw83hD7fKPwiIqWiuLTDJLukLpjtP4QN94yOaZy9BpFeSK24owZc',0,'2022-08-11 04:40:00','2024-10-08 13:03:52',NULL);
