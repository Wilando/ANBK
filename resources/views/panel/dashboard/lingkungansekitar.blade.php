...
@section("content")
    ...
    <!-- Kotak Lingkungan Sekitar dengan soal-soal di dalamnya -->
    <div class="survey-container">
        ...
        <div class="question-container">
            <p>1. Bagaimana Anda menjaga kebersihan lingkungan sekitar?</p>
            <div class="answer">
                <div>A. Menjaga kebersihan pribadi dan mengajak orang lain untuk menjaga kebersihan</div>
                <div>B. Hanya membuang sampah pada tempatnya tanpa memperhatikan lingkungan lainnya</div>
                <div>C. Mengabaikan kebersihan dan membiarkan orang lain menangani masalah tersebut</div>
                <div>D. Tidak peduli dengan kebersihan lingkungan sekitar</div>
            </div>
            <div class="answer-key">Kunci Jawaban: A</div>
        </div>

        <!-- Soal 2 tanpa radio button, hanya pilihan A, B, C -->
        <div class="question-container">
            <p>2. Apa yang Anda lakukan jika melihat sampah di tempat umum?</p>
            <div class="answer">
                <div>A. Segera memungut dan membuangnya pada tempat sampah</div>
                <div>B. Memberitahu orang lain untuk memungutnya</div>
                <div>C. Mengabaikan dan melanjutkan aktivitas seperti biasa</div>
            </div>
            <div class="answer-key">Kunci Jawaban: A</div>
        </div>
        ...
        <div class="question-container">
            <p>3. Bagaimana pendapat Anda tentang pentingnya menjaga kebersihan lingkungan?</p>
            <div class="answer">
                <div>A. Sangat penting untuk menjaga kebersihan lingkungan demi kenyamanan bersama</div>
                <div>B. Kebersihan lingkungan penting, tetapi bukan prioritas utama</div>
                <div>C. Tidak begitu penting, lingkungan tetap bisa berjalan meski kotor</div>
            </div>
            <div class="answer-key">Kunci Jawaban: A</div>
        </div>
...
@push('scripts')
    ...
    <script src="{{ asset('myjs/jquery/dt-lang.js') }}"></script>
@endpush
