...
@push('css')
    <style>
        ...
        /* Styling untuk Kotak Besar dengan Literasi Numerik */
        .literasi-container {
        ...
        /* Styling untuk Kotak Literasi Numerik */
        .literasi-box {
...
@section("content")
    ...
    <!-- Kotak Literasi Numerik dengan soal-soal di dalamnya -->
    <div class="literasi-container">
        <div class="literasi-box">
            <h3>Literasi Numerik</h3>
        </div>

        <!-- Soal 1 tanpa radio button, hanya pilihan A, B, C, D -->
        <div class="question-container">
            <p>1. Berapa hasil dari 5 + 7 x 2?</p>
            <div class="answer">
                <div>A. 24</div>
                <div>B. 19</div>
                <div>C. 17</div>
            ...
            <!-- Kotak kunci jawaban -->
            <div class="answer-key">Jawaban: B</div>
        </div>

        <!-- Soal 2 tanpa radio button, hanya pilihan A, B, C -->
        <div class="question-container">
            <p>2. Apa hasil dari 20 ÷ 4 + 3?</p>
            <div class="answer">
                <div>A. 10</div>
                <div>B. 8</div>
                <div>C. 13</div>
        ...
        <div class="question-container">
            <p>3. Jika 4x + 6 = 22, berapa nilai x?</p>
            <div class="answer">
                <div>A. 4</div>
                <div>B. 3</div>
                <div>C. 5</div>
