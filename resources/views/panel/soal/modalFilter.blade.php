        ...
        <div class="modal-content" style="min-height:300px">
            ...
            <div class="modal-body">
                ...
                <div class="row g-2">
                    ...
                    <div class="col-6">
                        <div class="form-floating">
                            <input style="width:100%" class="form-control form-control-sm" id="filter_tahun_awal" name="filter_tahun_awal">
                            <label for="filter_tahun_awal">Tahun Awal</label>
                        </div>
                    </div>

                    <div class="col-6">
                        <div class="form-floating">
                            <input style="width:100%" class="form-control form-control-sm" id="filter_tahun_akhir" name="filter_tahun_akhir">
                            <label for="filter_tahun_akhir">Tahun Akhir</label>
                        </div>
                    </div>
